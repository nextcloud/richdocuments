...
class OfficePresentationStarter extends ADiscoverableReferenceProvider {
	...
	public function getId(): string {
		return 'office-target-presentation';
	}

	public function getTitle(): string {
		return $this->l10n->t('Start presentation');
	}
	...
	public function getIconUrl(): string {
		return $this->urlGenerator->getAbsoluteURL($this->urlGenerator->imagePath(Application::APPNAME, '../img/x-office-presentation.svg'));
	}
}
