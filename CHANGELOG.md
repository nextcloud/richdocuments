...
### Fixed
- Verify initiator token type by @elzody in [#5851](https://github.com/nextcloud/richdocuments/pull/5851)
- Ensure initiator server is trusted by @elzody in [#5842](https://github.com/nextcloud/richdocuments/pull/5842)
