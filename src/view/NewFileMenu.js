...
const createFileTypeEntry = (type, displayName, iconClass) => ({
...
export const registerNewFileMenuEntries = () => {
	...
	fileTypes.forEach(({ type, displayName, iconClass }) => {
		addNewFileMenuEntry(createFileTypeEntry(type, displayName, iconClass))
	})
}
