OC.L10N.register(
    ...
    "New Spreadsheet.ods" : "Yeni elektronik tablo.ods",
    "New Presentation.odp" : "Yeni sunum.odp",
    "New Document.docx" : "Yeni belge.docx",
    "New Spreadsheet.xlsx" : "Yeni elektronik tablo.xlsx",
    "New Presentation.pptx" : "Yeni sunum.pptx",
    "File already exists" : "Dosya zaten var",
    "Not allowed to create document" : "Belge oluşturmaya izin verilmiyor",
    "Saved" : "Kaydedildi",
    ...
    "Conversion is unavailable for this file." : "Dönüştürme bu dosya için kullanılamaz.",
    "Conversion is blocked because the file is protected by Secure View." : "Dosya güvenli görüntüleme tarafından korunduğu için dönüştürme engellendi.",
    ...
    "OpenDocument Text (.odt)" : "OpenDocument yazısı (.odt)",
    "Excel Workbook (.xlsx)" : "Excel çalışma sayfası (.xlsx)",
    "OpenDocument Spreadsheet (.ods)" : "OpenDocument elektronik tablosu (.ods)",
    ...
    "This document was generated using Artificial Intelligence" : "Bu belge yapay zeka tarafından oluşturulmuştur.",
    "Headings" : "Başlıklar",
    "Sections" : "Bölümler",
    "Images" : "Görseller",
    "Sheets" : "Sayfalar",
    "Slides" : "Saydamlar",
    "Generated using Artificial Intelligence" : "Yapay zeka ile oluşturuldu",
    "Office" : "Office",
    ...
    "Write the text for your presentation here" : "Sunumunuzun yazısını buraya yazın",
    "Generated slide deck" : "Oluşturulan kayan tahta",
    "The slide deck generated" : "Kayan tahta oluşturuldu",
    "Nextcloud Office (Collabora) text document generator" : "Nextcloud Office (Collabora) yazı belgesi oluşturucu",
    ...
    "Generate Office text document" : "Office yazı belgesi oluştur",
    "Generate an Office text document from a prompt" : "Bir istemden bir Office yazı belgesi oluşturun",
    ...
    "Nextcloud Office (Collabora) spreadsheet generator" : "Nextcloud Office (Collabora) elektronik tablo oluşturucu",
    "OpenXML (xlsx)" : "OpenXML (xlsx)",
    "OpenDocument (ods)" : "OpenDocument (ods)",
    "Generate Office spreadsheet document" : "Office elektronik tablo belgesi oluştur",
    "Generate an Office spreadsheet document from a prompt" : "Bir istemden bir Office elektronik tablo belgesi oluşturun",
    "Empty" : "Boş",
    ...
    "Nextcloud Office (Collabora) requires a separate server running Collabora Online to provide editing capabilities." : "Nextcloud Office (Collabora) düzenleme özelliklerinin kullanılabilmesi için Collabora Online çalıştıran ayrı bir sunucu gereklidir.",
    ...
    "The settings only apply to compatible office files that are opened in Nextcloud Office (Collabora)" : "Ayarlar yalnızca Nextcloud Office (Collabora) ile açılan uyumlu ofis dosyaları için geçerlidir.",
    "Downloading the file through WebDAV will be blocked" : "Dosyanın WebDAV üzerinden indirilmesi engellenecek",
    "The following options within Nextcloud Office (Collabora) will be disabled: Copy, Download, Export, Print" : "Şu Nextcloud Office (Collabora) seçenekleri kullanımdan kaldırılacak: Kopyalama, İndirme, Dışa aktarma, Yazdırma",
    ...
    "The secret is only sent to requests that can be verified to come from the Collabora server. Generate a WOPI proof key on the Collabora server or configure the WOPI allow list, otherwise electronic signatures stay unavailable." : "Parola, yalnızca Collabora sunucusundan geldiği doğrulanabilen isteklere gönderilir. Collabora sunucusunda bir WOPI kanıt anahtarı oluşturun veya WOPI izin listesini yapılandırın, yoksa elektronik imzalar kullanılamaz.",
    ...
    "Save" : "Kaydet",
    "A file with that name already exists." : "Aynı adlı bir dosya zaten var.",
    "Error checking if file exists." : "Dosyanın var olup olmadığı denetlenirken sorun çıktı.",
    "Save as" : "Farklı kaydet",
    ...
    "Personal Settings for Nextcloud Office (Collabora)" : "Kişisel Nextcloud Office (Collabora) ayarları",
    "Select a template directory" : "Bir kalıp klasörü seçin",
    "Remove personal template folder" : "Kişisel kalıp klasörünü sil",
    "Templates inside of this directory will be added to the template selector of Nextcloud Office (Collabora)." : "Bu klasör içindeki kalıplar Nextcloud Office (Collabora) kalıp seçicisine eklenecek.",
    ...
    "Preview" : "Ön izleme",
    "Edit" : "Düzenle",
    "Starting the built-in CODE server …" : "İç CODE sunucusu başlatılıyor…",
    ...
    "Please check the Collabora Online server log for more details and make sure that Nextcloud can be reached from there." : "Daha fazla ayrıntı için lütfen Collabora Online sunucu günlüğü kayıtlarına bakın ve buradan Nextcloud üzerine erişilebildiğinden emin olun.",
    ...
    "Starting the built-in CODE server is taking longer than expected" : "İç CODE sunucusunun başlatılaması beklendiğinden uzun sürüyor",
