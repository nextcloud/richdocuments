OC.L10N.register(
    ...
    "This application can connect to a Office Online (or other) server (WOPI-like Client). Nextcloud is the WOPI Host. Please read the documentation to learn more about that." : "Bu uygulama ile bir Office Online (ya da diğer) sunucu ile bağlantı kurulabilir (WOPI benzeri istemci). Nextcloud WOPI sunucusudur. Ayrıntılı bilgi almak için belgelere bakabilirsiniz.",
    ...
    "Enable if your Office Online server uses a self signed certificate" : "Office Online sunucunuz kendinden imzalı bir sertifika kullanıyorsa etkinleştirin",
