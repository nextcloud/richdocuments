OC.L10N.register(
    ...
    "Please configure a Office Online server to start editing documents" : "Bitte konfiguriere einen Office Online-Server, um mit der Bearbeitung von Dokumenten zu beginnen",
    ...
    "You can use a demo server provided by Office and other service providers for giving Office Online a try." : "Du kannst einen von Office und anderen Dienstleistern zur Verfügung gestellten Demo-Server verwenden, um Office Online auszuprobieren.",
    ...
    "Documents opened with the demo server configured will be sent to a 3rd party server. Only use this for evaluating Office Online." : "Dokumente, die mit dem konfigurierten Demo-Server geöffnet werden, werden an einen Server eines Drittanbieters gesendet. Verwende diesen nur zur Evaluierung von Office Online.",
