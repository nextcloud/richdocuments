OC.L10N.register(
    ...
    "Conversion is unavailable for this file." : "Für diese Datei ist keine Konvertierung möglich.",
    "Conversion is blocked because the file is protected by Secure View." : "Die Konvertierung wird blockiert, da die Datei durch Secure View geschützt ist.",
    ...
    "Sheets" : "Blätter",
    "Slides" : "Folien",
    "Generated using Artificial Intelligence" : "Erstellt mit künstlicher Intelligenz",
    "Office" : "Office",
    ...
    "Write the text for your presentation here" : "Schreibe hier den Text für deine Präsentation",
    "Generated slide deck" : "Erstellter Foliensatz",
    "The slide deck generated" : "Der erstellte Foliensatz",
    "Nextcloud Office (Collabora) text document generator" : "Textdokumentgenerator von Nextcloud Office (Collabora)",
    ...
    "Nextcloud Office (Collabora) spreadsheet generator" : "Tabellenkalkulationsgenerator von Nextcloud Office (Collabora)",
    ...
    "Nextcloud Office (powered by Collabora Online) is a powerful online office suite with collaborative editing, which supports all major documents, spreadsheet and presentation file formats and works together with all modern browsers." : "Nextcloud Office (unterstützt von Collabora Online) ist eine leistungsstarke Online-Office-Suite mit kollaborativer Bearbeitung, die alle wichtigen Dokumente, Tabellenkalkulations- und Präsentationsdateiformate unterstützt und mit allen modernen Browsern zusammenarbeitet.",
    ...
    "Nextcloud Office (Collabora) requires a separate server running Collabora Online to provide editing capabilities." : "Nextcloud Office (Collabora) benötigt einen separaten Server, auf dem Collabora Online ausgeführt wird, um Bearbeitungsfunktionen bereitzustellen.",
    ...
    "If the installation from the App Store fails, you can still do that manually using this command:" : "Sollte die Installation aus dem App-Store fehlschlagen, kann manuell mit folgendem Befehl installiert werden:",
    ...
    "Secure view enables you to secure office documents by blocking downloads, previews and showing a watermark" : "Mit der sicheren Ansicht kannst du Office-Dokumente schützen, indem du Downloads und Vorschauen blockierst und ein Wasserzeichen anzeigst.",
    "The settings only apply to compatible office files that are opened in Nextcloud Office (Collabora)" : "Die Einstellungen gelten nur für kompatible Office-Dateien, die in Nextcloud Office (Collabora) geöffnet werden",
    "Downloading the file through WebDAV will be blocked" : "Das Herunterladen der Datei über WebDAV wird blockiert",
    "The following options within Nextcloud Office (Collabora) will be disabled: Copy, Download, Export, Print" : "Die folgenden Optionen innerhalb von Nextcloud Office (Collabora) werden deaktiviert: Kopieren, Herunterladen, Exportieren, Drucken",
    ...
    "The secret is only sent to requests that can be verified to come from the Collabora server. Generate a WOPI proof key on the Collabora server or configure the WOPI allow list, otherwise electronic signatures stay unavailable." : "Das Geheimnis wird nur an Anfragen gesendet, deren Herkunft vom Collabora-Server überprüft werden kann. Erstelle einen WOPI-Beweisschlüssel auf dem Collabora-Server oder konfiguriere die WOPI-Zulassungsliste, andernfalls sind elektronische Signaturen nicht verfügbar.",
    ...
    "Save" : "Speichern",
    "A file with that name already exists." : "Eine Datei mit diesem Namen existiert bereits.",
    "Error checking if file exists." : "Fehler bei der Überprüfung, ob die Datei existiert.",
    "Save as" : "Speichern als",
    ...
    "Personal Settings for Nextcloud Office (Collabora)" : "Persönliche Einstellungen für Nextcloud Office (Collabora)",
    "Select a template directory" : "Vorlagenordner auswählen",
    "Remove personal template folder" : "Persönlichen Vorlagenordner entfernen",
    "Templates inside of this directory will be added to the template selector of Nextcloud Office (Collabora)." : "Vorlagen innerhalb dieses Ornders werden der Vorlagenauswahl von Nextcloud Office (Collabora) hinzugefügt.",
    ...
    "Preview" : "Vorschau",
    "Edit" : "Bearbeiten",
    "Starting the built-in CODE server …" : "Starten des integrierten CODE-Servers …",
    ...
    "Starting the built-in CODE server is taking longer than expected" : "Das Starten des integrierten CODE-Servers dauert länger als erwartet.",
    ...
    "Secure view enables you to secure documents by embedding a watermark" : "Die sichere Ansicht ermöglicht es, Dokumente durch Einbettung eines Wasserzeichens abzusichern.",
