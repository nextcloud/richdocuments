...
"guest" => "ゲスト",
"Local" => "ローカル",
"openOffice/libreOffice is installed on this server" => "openOfficeまたはlibreOfficeは、このサーバーにインストールされています",
"External" => "外部",
"openOffice/libreOffice is installed on another server" => "openOffice または libreOffice は、他のサーバーにインストールされています",
