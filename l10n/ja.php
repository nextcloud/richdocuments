...
"Format filter server is down or misconfigured" => "フォーマットフィルタサーバが稼働していないか設定ミス",
...
"guest" => "ゲスト",
"Local" => "ローカル",
"openOffice/libreOffice is installed on this server" => "openOffice または libreOffice は、このサーバにインストールされています",
"External" => "外部",
"openOffice/libreOffice is installed on another server" => "openOffice または libreOffice は、他のサーバにインストールされています",
