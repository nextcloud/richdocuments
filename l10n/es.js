OC.L10N.register(
    ...
    "This application can connect to a Office Online (or other) server (WOPI-like Client). Nextcloud is the WOPI Host. Please read the documentation to learn more about that." : "Esta aplicación puede conectarse a un servidor de Office Online (u otro) servidor (cliente tipo WOPI). Nextcloud es el host WOPI. Por favor, lee la documentación para conocer más sobre esto.",
    ...
    "Last saved version" : "ultimately versión guardada",
    ...
    "Enable if your Office Online server uses a self signed certificate" : "Actívualo si tu servidor Office Online usa un certificado autofirmado",
    ...
    "All users can edit documents with Office Online by default. When this setting is active, only the members of the specified groups can edit and the others can only view documents." : "Todos los usuarios pueden editar documentos con Office Online por defecto. Cuando esta configuración se activa, solo los miembros de los grupos especificados pueden editar y los otros solo pueden ver documentos.",
