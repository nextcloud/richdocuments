OC.L10N.register(
    ...
    "Unable to determine the proper file extension for %1$s" : "No ha sido posible encontrar la extensión de archivo apropiada para %1$s",
    "Unable to fetch information on %1$s" : "No se ha podido obtener información de %1$s",
    "PDF (.pdf)" : "PDF (.pdf)",
    ...
    "Excel Workbook (.xlsx)" : "Hoja de Cálculo de Excel (.xlsx)",
    ...
    "{user} has mentioned you in {node}" : "{user} le ha mencionado en {node}",
    ...
    "Slides" : "Diapositivas",
    "Office" : "Office",
    "Nextcloud Assistant Slide Deck Generator" : "Generador de grupo de diapositivas del Asistente Nextcloud",
    "Generate Slide Deck" : "Generar grupo de diapositivas",
    "Generate a slide deck from a presentation script" : "Generar un grupo de diapositivas desde un script de presentación",
    "Presentation script" : "Script de presentación",
    "Write the text for your presentation here" : "Escriba el texto para su presentación aquí",
    "Generated slide deck" : "Grupo de diapositivas generado",
    "The slide deck generated" : "El grupo de diapositivas generado",
    "Nextcloud Office text document generator" : "Generador de documentos de texto de Nextcloud Office",
    "Document format" : "Formato del documento",
    "The format of the generated document" : "El formato del documento generado",
    "OpenXML (docx)" : "OpenXML (docx)",
    "OpenDocument (odt)" : "OpenDocument (odt)",
    "Portable Document Format (pdf)" : "Portable Document Format (pdf)",
    "Generate Office text document" : "Generar documento de texto de Office",
    "Generate an Office text document from a prompt" : "Generar documento de texto de Office desde un prompt",
    "Instructions" : "Instrucciones",
    "Describe the document you want the assistant to generate" : "Describa el documento que desea que el asistente genere",
    "Generated Office document" : "Documento de Office generado",
    "The Office document that was generated from the description" : "El documento de Office que fue generado desde la descripción",
    "Nextcloud Office spreadsheet generator" : "Generador de hojas de cálculo de Nextcloud Office",
    "OpenXML (xlsx)" : "OpenXML (xlsx)",
    "OpenDocument (ods)" : "OpenDocument (ods)",
    "Generate Office spreadsheet document" : "Generar documento de hoja de cálculo de Office",
    "Generate an Office spreadsheet document from a prompt" : "Generar un documento de hoja de cálculo de Office desde un prompt",
    "Empty" : "Vacío",
    ...
    "Secure view enables you to secure office documents by blocking downloads, previews and showing a watermark" : "La vista segura le permite asegurar los documentos al bloquear las descargas, vistas previas y mostrando una marca de agua.",
    ...
    "Downloading the file through WebDAV will be blocked" : "Se bloqueará la descarga del archivo a través de WebDAV",
    ...
    "Previews will be blocked" : "Las vistas previas se bloquearán",
    "Enable secure view" : "Habilitar vista segura",
    "Supported placeholders: {userId}, {userDisplayName}, {email}, {date}, {themingName}" : "Marcadores de posición soportados: {userId}, {userDisplayName}, {email}, {date}, {themingName}",
    "Enforce secure view on tagged files" : "Hacer obligatoria la vista segura en los archivos etiquetados",
    "Select tags to enforce watermarking" : "Seleccionar etiquetas para forzar las marcas de agua",
    "Enforce secure view for users of groups" : "Hacer obligatoria la vista segura para usuarios de grupos",
    "Enforce secure view for all shares" : "Hacer obligatoria la vista segura para todos los recursos compartidos",
    "Enforce secure view for read only shares" : "Hacer obligatoria la vista segura para los recursos compartidos de sólo lectura",
    "Enforce secure view for all public Talk shares" : "Hacer obligatoria la vista segura para todos los recursos compartidos públicos de Talk",
    "Enforce secure view for shares without download permission" : "Hacer obligatoria la vista segura para los recursos compartidos que no tienen permisos de descarga",
    "Enforce secure view for all link shares" : "Hacer obligatoria la vista segura para todos los recursos compartidos de enlace",
    "Enforce secure view for download hidden shares" : "Hacer obligatoria la vista segura para los recursos compartidos de descarga ocultos ",
    "Enforce secure view for read only link shares" : "Hacer obligatoria la vista segura para los recursos compartidos de enlace que son de sólo lectura",
    "Enforce secure view on link shares with specific system tags" : "Hacer obligatoria la vista segura para los recursos compartidos de enlace que poseen etiquetas específicas del sistema",
    "Select tags to enforce secure view" : "Seleccione las etiquetas para hacer obligatoria la vista segura",
    ...
    "Fill in the registration form at https://eideasy.com/signup to obtain a client ID and secret." : "Rellene el formulario de registro en https://eideasy.com/signup para obtener un ID de cliente y un secreto",
    ...
    "File name already exists" : "El nombre de archivo ya existe",
    "Select template" : "Seleccionar plantilla",
    "File name" : "Nombre del archivo",
    "Create" : "Crear",
    "Failed to set Zotero API key" : "No fue posible establecer la clave API de Zotero",
    ...
    "Zotero API key" : "Clave API Zotero",
    "Submit" : "Enviar",
    ...
    "Zotero" : "Zotero",
    "Enter Zotero API Key" : "Ingrese la clave API de Zotero",
    "Remove Zotero API Key" : "Quitar la clave API de Zotero",
    "To use Zotero specify your API key here. You can create your API key in your" : "Para utilizar Zotero, especifique su clave API aquí. Puede crear su llave API en su",
    ...
    "Enter document signing cert (in PEM format)" : "Introduzca el certificado para la firma de documentos (en formato PEM)",
    "Enter document signing key" : "Introduzca la llave para firma de documentos",
    "Enter document signing CA chain" : "Introduzca la cadena de CA para firma de documentos",
    "To use document signing, specify your signing certificate, key and CA chain here." : "Para utilizar la firma de documentos, especifique aquí su certificado, clave y cadena CA de firma.",
    "This instance does not support document signing, because the feature is missing or disabled. Please contact the administrator." : "Esta instancia no soporta la firma de documentos, ya que la característica no existe o está desactivada. Por favor, contacte al administrador.",
    ...
    "Collabora Online is not setup yet. Please contact your administrator." : "Collabora Online no se encuentra configurado todavía. Por favor, contacte a su administrador.",
    "Opening the file is not supported, since the credentials for the external storage are not available without a session" : "No está soportada la apertura del archivo, ya que las credenciales para el almacenamiento externo no están disponibles sin una sesión",
