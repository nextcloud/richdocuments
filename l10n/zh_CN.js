OC.L10N.register(
    ...
    "Install it from the app store." : "从应用商店安装。",
    "If the installation from the app store fails, you can still do that manually using this command:" : "如果从应用商店安装失败，您仍然可以使用以下命令手动进行安装：",
