OC.L10N.register(
    ...
    "List of IPV4 and IPV6 IP-addresses and subnets that are allowed to perform requests of the WOPI endpoints. If no allow list is specified all hosts will be allowed. E.g. 10.0.0.20,10.0.4.0/24" : "允许执行WOPI端点请求的IPV4和IPV6 ip 地址和子网列表。如果没有指定允许列表，所有的主机都将被允许。比如，10.0.0.20,10.0.4.0/24",
    ...
    "Error: Cannot find the AppImage, please reinstall the Collabora Online Built-in server." : "错误：找不到 AppImage，请重新安装在线协作内建服务器。",
    ...
    "Error: Cannot start the Collabora Online Built-in server, please setup a standalone one." : "错误：无法启动在线协作内建服务器，请设置一个独立的服务器。",
    ...
    "Install it from the app store." : "从应用商店安装它。",
    "If the installation from the app store fails, you can still do that manually using this command:" : "如果从应用商店安装失败，您依旧可以使用这条命令手动安装：",
