OC.L10N.register(
    ...
    "This application can connect to a Collabora Online (or other) server (WOPI-like Client). Nextcloud is the WOPI Host. Please read the documentation to learn more about that." : "此应用可连接到一台在线（或其他）服务器（类WOPI客户端）。NextCloud则是WOPI主机。更详细信息请阅读文档。",
    ...
    "All users can edit documents with Collabora Online by default. When this setting is active, only the members of the specified groups can edit and the others can only view documents." : "默认情况下所有用户都能使用在线协作编辑文档。当此设置激活时，只有特定分组的成员才能编辑文档，而其他用户只能查看文档。",
