OC.L10N.register(
    "richdocuments",
    {
    "No files found for this task." : "未找到该任务的文件。",
    ...
    "Failed to upload the file" : "无法上传文件",
    ...
    "OpenDocument Text (.odt)" : "OpenDocument 文本 (.odt)",
    "Excel Workbook (.xlsx)" : "Excel 工作簿 (.xlsx)",
    "OpenDocument Spreadsheet (.ods)" : "OpenDocument 电子表格 (.ods)",
    "PowerPoint Presentation (.pptx)" : "PowerPoint 演示文稿 (.pptx)",
    "OpenDocument Presentation (.odp)" : "OpenDocument 演示文稿 (.odp)",
    "New document" : "新文档",
    "New spreadsheet" : "新表格",
    ...
    "Sheets" : "工作表",
    "Slides" : "幻灯片",
    "Generated using Artificial Intelligence" : "使用 AI 生成",
    "Office" : "Office",
    "Nextcloud Assistant Slide Deck Generator" : "Nextcloud 助手幻灯片 Deck 生成器",
    "Generate Slide Deck" : "生成幻灯片 Deck",
    "Generate a slide deck from a presentation script" : "从演示文稿脚本生成幻灯片 Deck",
    "Presentation script" : "演示文稿脚本",
    ...
    "Nextcloud Office text document generator" : "Nextcloud Office 文本文档生成器",
    ...
    "Portable Document Format (pdf)" : "便携式文档格式 (pdf)",
    "Generate Office text document" : "生成 Office 文本文档",
    "Generate an Office text document from a prompt" : "根据提示生成 Office 文本文档",
    "Instructions" : "说明",
    ...
    "Nextcloud Office spreadsheet generator" : "Nextcloud Office 电子表格生成器",
    "OpenXML (xlsx)" : "OpenXML (xlsx)",
    "OpenDocument (ods)" : "OpenDocument (ods)",
    "Generate Office spreadsheet document" : "生成 Office 电子表格文档",
    "Generate an Office spreadsheet document from a prompt" : "根据提示生成 Office 电子表格文档",
    "Empty" : "空",
    ...
    "Instance-wide templates that should be available to all users." : "应可供所有用户使用的实例范围模板。",
    ...
    "For ideal document compatibility we recommend you to install commonly used fonts. If your users are working with Microsoft Office, installing their proprietary fonts can be done following the documentation." : "为了获得理想的文档兼容性，我们建议您安装常用字体。如果您的用户使用的是 Microsoft Office，则可以按照文档安装其专有字体。",
    ...
    "The settings only apply to compatible office files that are opened in Nextcloud Office" : "此设置仅适用于在 Nextcloud Office 中打开的兼容办公文件",
    ...
    "Supported placeholders: {userId}, {userDisplayName}, {email}, {date}, {themingName}" : "支持的占位符：{userId}、{userDisplayName}、{email}、{date}、{themingName}",
    "Enforce secure view on tagged files" : "对标记的文件强制执行安全视图",
    "Select tags to enforce watermarking" : "选择标签以强制打水印",
    "Enforce secure view for users of groups" : "为群组用户强制执行安全视图",
    "Enforce secure view for all shares" : "为所有分享强制执行安全视图",
    "Enforce secure view for read only shares" : "为只读分享强制执行安全视图",
    "Enforce secure view for all public Talk shares" : "为所有公共 Talk 分享强制执行安全视图",
    "Enforce secure view for shares without download permission" : "为没有下载权限的分享强制执行安全视图",
    "Enforce secure view for all link shares" : "为所有链接分享强制执行安全视图",
    "Enforce secure view for download hidden shares" : "为下载的隐藏分享强制执行安全视图",
    "Enforce secure view for read only link shares" : "为只读链接分享强制执行安全视图",
    "Enforce secure view on link shares with specific system tags" : "对具有特定系统标签的链接分享强制执行安全视图",
    "Select tags to enforce secure view" : "选择标签以强制执行安全视图",
    ...
    "Error checking if file exists." : "检查文件是否存在时出错。",
    "Save as" : "另存为",
    "Path to save" : "存储路径",
    "Checking…" : "正在检查…",
    ...
    "Built-in CODE server failed to start" : "内置 CODE 服务器无法启动",
    ...
    "New filename" : "新文件名",
    "Collabora Online is not setup yet. Please contact your administrator." : "Collabora Online 尚未设置。请联系您的管理员。",
    "Opening the file is not supported, since the credentials for the external storage are not available without a session" : "不支持打开文件，因为没有会话，外部存储的凭据就不可用",
    "Failed to connect to {productName}. Please try again later or contact your server administrator." : "无法连接到 {productName}。请稍后重试或联系您的服务器管理员。",
    "Saving…" : "正在保存 ...",
