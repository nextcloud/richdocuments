OC.L10N.register(
    ...
    "Electronic signature settings" : "电子签名设置",
    ...
    "Failed to update the document signing CA chain" : "无法更新文件签名CA",
    "Saving …" : "正在保存 …",
    ...
    "Save document signing cert" : "保存文件签名证书",
    "Remove document signing cert" : "移除文件签名证书",
    "Enter document signing key" : "输入文件签名秘钥",
    "Save document signing key" : "保存文件签名秘钥",
    "Remove document signing key" : "移除文件签名秘钥",
