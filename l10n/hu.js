OC.L10N.register(
    ...
    "Personal Settings for Nextcloud Office (Collabora)" : "A Nextcloud Office (Collabora) személyes beállításai",
    "Select a template directory" : "Válasszon sablonkönyvtárat",
    "Remove personal template folder" : "Személyes sablonmappa eltávolítása",
    "Document signing" : "Dokumentum aláírása",
    "Enter document signing cert (in PEM format)" : "Adja meg a dokumentum aláírásához szükséges tanúsítványt (PEM formátumban)",
    "Enter document signing key" : "Adja meg a dokumentum aláírási kulcsát",
    "Enter document signing CA chain" : "Adja meg a dokumentum aláírásához használt hitelesítési láncot",
    "To use document signing, specify your signing certificate, key and CA chain here." : "A dokumentumaláírás használatához itt adja meg az aláírási tanúsítványát, kulcsát és a hitelesítő láncát.",
    "Description" : "Leírás",
