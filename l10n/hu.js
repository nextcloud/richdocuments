OC.L10N.register(
    ...
    "{productName} is enabled for all users by default. When this setting is active, only members of the specified groups can use it." : "Alapértelmezetten a(z) {productName} az összes felhasználó számára elérhető. Ha ez a beállítás aktív, akkor csak a megadott csoportok tagjai használhatják.",
    ...
    "{productName} is not configured" : "A(z) {productName} nincs beállítva",
    "Error" : "Hiba",
    ...
    "Open with {productName}" : "Megnyitása a következővel: {productName}",
