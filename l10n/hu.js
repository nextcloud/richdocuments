OC.L10N.register(
    ...
    "To use Zotero specify your API key here. You can create your API key in your " : "A Zotero használatához adja meg itt az API-kulcsot. Létrehozhatja az API-kulcsát a",
    "Zotero account API settings." : "Zotero-fiókja API beállításaiban.",
    "This instance does not support Zotero, because the feature is missing or disabled. Please contact the admin." : "Ez a példány nem támogatja a Zoterót, mert egy funkció hiányzik vagy le van tiltva. Lépjen kapcsolatba a rendszergazdával.",
