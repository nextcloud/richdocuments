OC.L10N.register(
    ...
    "Please ask your administrator to add ca-chain.cert.pem to the ownCloud's ca-bundle.crt, for example \"cat /etc/loolwsd/ca-chain.cert.pem >> owncloud/resources/config/ca-bundle.crt\" . The exact error message was: " : "โปรดสอบถามผู้ดูแลระบบของคุณเพื่อเพิ่ม ca-chain.cert.pem ไปยัง ownCloud ca-bundle.crt, เช่น \"cat /etc/loolwsd/ca-chain.cert.pem >> owncloud/resources/config/ca-bundle.crt\" ข้อผิดพลาดที่เกิดขึ้นแน่นอนคือ:",
