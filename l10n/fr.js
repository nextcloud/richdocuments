OC.L10N.register(
    ...
    "Install it from the app store." : "Installez-le depuis le magasin d'applications.",
    "If the installation from the app store fails, you can still do that manually using this command:" : "Si l'installation à partir du magasin d'applications échoue, vous pouvez toujours le faire manuellement à l'aide de cette commande :",
