OC.L10N.register(
    ...
    "To use Zotero specify your API key here. You can create your API key in your " : "Pour utiliser Zotero, spécifiez votre clé d'API ici. Vous pouvez créer votre clé d'API dans votre ",
    "Zotero account API settings." : "Paramètres de l'API du compte Zotero.",
    "This instance does not support Zotero, because the feature is missing or disabled. Please contact the admin." : "Cette instance ne prend pas en charge Zotero, car cette fonctionnalité est manquante ou désactivée. Veuillez contacter l'administrateur.",
