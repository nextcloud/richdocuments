OC.L10N.register(
    ...
    "This application can connect to a Office Online (or other) server (WOPI-like Client). Nextcloud is the WOPI Host. Please read the documentation to learn more about that." : "Cette application (en tant que client WOPI) peut se connecter à un serveur Office Online (ou autre). Nextcloud agit en tant qu'hôte WOPI. Veuillez lire la documentation pour en savoir plus sur le fonctionnement.",
    ...
    "Enable if your Office Online server uses a self signed certificate" : "Activer si votre serveur Office Online utilise un certificat auto-signé",
    ...
    "All users can edit documents with Office Online by default. When this setting is active, only the members of the specified groups can edit and the others can only view documents." : "Tous les utilisateurs peuvent modifier des documents avec Office Online par défaut. Lorsque ce paramètre est actif, seuls les membres des groupes spécifiés peuvent être édités et les autres peuvent uniquement afficher les documents.",
