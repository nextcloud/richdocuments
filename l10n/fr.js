OC.L10N.register(
    ...
    "Conversion is unavailable for this file." : "La conversion n'est pas disponible pour ce fichier.",
    "Conversion is blocked because the file is protected by Secure View." : "La conversion est bloquée, car ce fichier est protégé par Secure View.",
    ...
    "This document was generated using Artificial Intelligence" : "Ce document a été généré avec l'utilisation de l'Intelligence Articificielle",
    "Headings" : "Titres",
    "Sections" : "Sections",
    "Images" : "Images",
    "Sheets" : "Feuilles",
    "Slides" : "Diapositives",
    "Generated using Artificial Intelligence" : "Généré avec l'utilisation de l'Intelligence Artificielle",
    "Office" : "Office",
    ...
    "Nextcloud Office (Collabora) text document generator" : "Générateur de documents texte Nextcloud Office (Collabora)",
    ...
    "Nextcloud Office (Collabora) spreadsheet generator" : "Générateur de feuilles de calcul Nextcloud Office (Collabora)",
    ...
    "Instance-wide templates that should be available to all users." : "Modèles disponibles pour tous les utilisateurs de cette instance.",
    ...
    "Nextcloud Office (Collabora) requires a separate server running Collabora Online to provide editing capabilities." : "Nextcloud Office (Collabora) nécessite un serveur distinct exécutant Collabora Online afin de fournir les fonctionnalités d'édition.",
    ...
    "The settings only apply to compatible office files that are opened in Nextcloud Office (Collabora)" : "Ces paramètres s'appliquent uniquement aux fichiers bureautiques compatibles ouverts dans Nextcloud Office (Collabora).",
    "Downloading the file through WebDAV will be blocked" : "Le téléchargement du fichier via WebDAV sera bloqué",
    "The following options within Nextcloud Office (Collabora) will be disabled: Copy, Download, Export, Print" : "Les options suivantes seront désactivées dans Nextcloud Office (Collabora) : Copier, Télécharger, Exporter, Imprimer.",
    ...
    "Enforce secure view on tagged files" : "Forcer l'affichage sécurisé pour les fichiers étiquetés",
    "Select tags to enforce watermarking" : "Sélectionner des étiquettes pour appliquer le filigrane",
    "Enforce secure view for users of groups" : "Forcer l'affichage sécurisé pour les utilisateurs des groupes",
    "Enforce secure view for all shares" : "Forcer l'affichage sécurisé pour tous les partages",
    "Enforce secure view for read only shares" : "Forcer l'affichage sécurisé pour partages en lecture seule",
    "Enforce secure view for all public Talk shares" : "Forcer l'affichage sécurisé pour les partages publics de Talk",
    "Enforce secure view for shares without download permission" : "Forcer l'affichage sécurisé pour les partages sans droit de téléchargement",
    "Enforce secure view for all link shares" : "Forcer l'affichage sécurisé pour tous les liens de partage",
    "Enforce secure view for download hidden shares" : "Forcer l'affichage sécurisé pour les partages avec téléchargement masqué",
    "Enforce secure view for read only link shares" : "Forcer l'affichage sécurisé pour les liens de partage en lecture seule",
    "Enforce secure view on link shares with specific system tags" : "Forcer l'affichage sécurisé pour les liens de partage avec des étiquettes spécifiques",
    "Select tags to enforce secure view" : "Sélectionnez des étiquettes pour forcer l'affichage sécurisé",
    ...
    "The secret is only sent to requests that can be verified to come from the Collabora server. Generate a WOPI proof key on the Collabora server or configure the WOPI allow list, otherwise electronic signatures stay unavailable." : "Le secret est envoyé uniquement aux demandes dont il est possible de vérifier qu'elles proviennent du serveur Collabora. Générez une clé de preuve WOPI sur le serveur Collabora ou configurez la liste d'autorisation WOPI, sinon les signatures électroniques resteront indisponibles.",
    ...
    "Error checking if file exists." : "Erreur lors de la vérification de l'existence du fichier.",
    "Save as" : "Enregistrer sous",
    ...
    "Personal Settings for Nextcloud Office (Collabora)" : "Paramètres personnels de Nextcloud Office (Collabora)",
    ...
    "Templates inside of this directory will be added to the template selector of Nextcloud Office (Collabora)." : "Les modèles présents dans ce répertoire seront ajoutés au sélecteur de modèles de Nextcloud Office (Collabora).",
    ...
    "Edit" : "Modifier",
    "Starting the built-in CODE server …" : "Démarrage du serveur CODE intégré…",
    ...
    "Continue editing online" : "Continuer à modifier en ligne",
    ...
    "Starting the built-in CODE server is taking longer than expected" : "Le démarrage du serveur CODE intégré prend plus de temps que prévu.",
