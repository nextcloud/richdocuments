OC.L10N.register(
    ...
    "Saved" : "Vistað",
    "Saved with error: Office Online should use the same protocol as the server installation." : "Vistað með villu: Office Online ætti að nota sama samskiptamáta og uppsetning þjónsins.",
    ...
    "This application can connect to a Office Online (or other) server (WOPI-like Client). Nextcloud is the WOPI Host. Please read the documentation to learn more about that." : "Þetta forrit getur tengst Office Online (eða öðrum slíkum) þjóni (WOPI-líkur biðlari). Nextcloud er þá WOPI-hýsill. Lestu hjálparskjölin til að fræðast meira um allt þetta.",
    ...
    "Office Online is a powerful LibreOffice-based online office suite with collaborative editing, which supports all major documents, spreadsheet and presentation file formats and works together with all modern browsers." : "Office Online er öflugur vöndull vinnuforrita byggður á LibreOffice og er með hópvinnslueiginleikum sem styðja við skráasnið allra helstu gerða skjala, töflureikna og kynninga, auk þess að virka í öllum nútímalegum vöfrum.",
    "URL (and Port) of Office Online-server" : "URL-slóð (og gátt) Office Online þjónsins",
    "Apply" : "Virkja",
    "Office Online requires a seperate server acting as a WOPI-like Client to provide editing capabilities." : "Office Online krefst þess að sérstakur þjónn vinni sem WOPI-líkur biðlari svo hægt sé að breyta skjölum.",
    "Disable certificate verification (insecure)" : "Gera sannvottun skilríkja óvirka (óöruggt)",
    "Enable if your Office Online server uses a self signed certificate" : "Virkja þetta ef Office Online þjónninn notar skilríki undirritað af handhafa",
    "Restrict usage to specific groups" : "Takmarka notkun við tiltekna hópa",
    "Office Online is enabled for all users by default. When this setting is active, only members of the specified groups can use it." : "Office Online er sjálfgefið virkjað fyrir alla notendur. Þegar þessi stilling er virk, geta aðeins meðlimir tiltekinna hópa notað það.",
    "Restrict edit to specific groups" : "Takmarka breytingar við tiltekna hópa",
    "All users can edit documents with Office Online by default. When this setting is active, only the members of the specified groups can edit and the others can only view documents." : "Sjálfgefið geta allir notendur breytt skjölum með Office Online. Þegar þessi stilling er virk, geta aðeins meðlimir tiltekinna hópa breytt skjölum og aðrir aðeins sköðað þau.",
    ...
    "Templates inside of this directory will be added to the template selector of Office Online." : "Sniðmátum inni í þessari möppu verður bætt í sniðmátaval Office Online.",
