OC.L10N.register(
    ...
    "Use the built-in testing server" : "Χρήση του ενσωματωμένου διακομιστή δοκιμών",
    "This installation has a built-in Collabora Online with limited capabilities for testing" : "Η εγκατάσταση έχει ενσωματωμένη την Collabora Online με περιορισμούς για λόγους δοκιμών",
    "This installation does not have a built-in Collabora Online test server" : "Η εγκατάσταση δεν έχει ενσωματωμένο διακομιστή δοκιμών της Collabora Online",
