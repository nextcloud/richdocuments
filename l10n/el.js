OC.L10N.register(
    ...
    "Easy to install, for personal use or for small teams. A bit slower than a standalone server and without the advanced scalability features." : "Εύκολη εγκατάσταση, για προσωπική χρήση ή για μικρές ομάδες. Λίγο πιο αργό από έναν αυτόνομο διακομιστή και χωρίς τις προηγμένες δυνατότητες επεκτασιμότητας.",
