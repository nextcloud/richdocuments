OC.L10N.register(
    ...
    "The secret is only sent to requests that can be verified to come from the Collabora server. Generate a WOPI proof key on the Collabora server or configure the WOPI allow list, otherwise electronic signatures stay unavailable." : "此密鑰只會傳送給可驗證為來自 Collabora 伺服器的請求。請在 Collabora 伺服器上產生 WOPI 證明金鑰，或設定 WOPI 允許清單，否則電子簽署功能將維持不可用。",
