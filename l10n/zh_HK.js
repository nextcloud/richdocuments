OC.L10N.register(
    ...
    "To use Zotero specify your API key here. You can create your API key in your " : "要使用 Zotero，請在此處指定您的 API 密鑰。您可以建立您的 API 密鑰，在您的",
    "Zotero account API settings." : "Zotero 賬戶 API 設定。",
    "This instance does not support Zotero, because the feature is missing or disabled. Please contact the admin." : "此實例不支援 Zotero，因為缺少功能或停用。請聯絡管理員。",
