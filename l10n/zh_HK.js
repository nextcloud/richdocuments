OC.L10N.register(
    ...
    "When opening a file locally, the document will close for all users currently viewing the document." : "在近端打開文件時，該文件將對當前查看該文件的所有用戶關閉。",
    "Open locally" : "在近端打開",
    ...
    "Insert image from {name}" : "從 {name} 插入圖像",
    ...
    "Save Zotero API key" : "保存 Zotero API 密鑰",
    ...
    "Save document signing key" : "儲存文件簽署密鑰",
    "Remove document signing key" : "移除文件簽署密鑰",
    ...
    "Current version (unsaved changes)" : "當前版本（未保存的更改）",
