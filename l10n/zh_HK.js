OC.L10N.register(
    ...
    "The following options within Nextcloud Office will be disabled: Copy, Download, Export, Print" : "Nextcloud Office 中的以下選項將被停用：複製、下載、導出、列印",
    ...
    "Zotero" : "Zotero",
    "Enter Zotero API Key" : "輸入 Zotero API 密鑰",
    "Remove Zotero API Key" : "移除 Zotero API 密鑰",
    "To use Zotero specify your API key here. You can create your API key in your" : "要使用 Zotero，請在此處指定您的 API 密鑰。您可以在您的",
    "Zotero account API settings." : "Zotero 帳戶 API 設定。",
