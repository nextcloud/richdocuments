OC.L10N.register(
    ...
    "New Presentation.odp" : "新演示文稿.odp",
    ...
    "Conversion is blocked because the file is protected by Secure View." : "檔案受 Secure View 保護，無法轉換。",
    ...
    "Presentation" : "簡報",
    "Diagram" : "圖表",
    "{user} has mentioned you in {node}" : "{user} 在 {node} 中提及您",
    "Link to office document section" : "連結到 Office 文件區塊",
    "Nextcloud Office (Collabora)" : "Nextcloud Office (Collabora)",
    "This document was generated using Artificial Intelligence" : "此文件由人工智能產生",
    "Headings" : "標題",
    "Sections" : "區塊",
    "Images" : "圖像",
    "Sheets" : "工作表",
    "Slides" : "幻燈片",
    "Generated using Artificial Intelligence" : "由人工智能產生",
    "Office" : "Nextcloud Office",
    "Nextcloud Assistant Slide Deck Generator" : "Nextcloud 小幫手幻燈片產生器",
    "Generate Slide Deck" : "産生幻燈片",
    ...
    "Generated slide deck" : "已産生的幻燈片",
    "The slide deck generated" : "已產生幻燈片",
    ...
    "Instance-wide templates that should be available to all users." : "應提供給所有用戶的站台全域範本。",
    "Uploaded template \"{name}\"" : "已上傳模板「{name}」",
    "Template \"{name}\" already exists" : "模板「{name}」已存在",
    "Unable to delete template" : "無法刪除模板",
    "Deleted template" : "已刪除模板",
    "Global Templates" : "整體的模板",
    "New" : "新",
    ...
    "Your browser has been unable to connect to the Collabora server:" : "您的瀏覽器無法連接到 Collabora 伺服器：",
    "This URL is determined on the Collabora server either from the configured URL or the server_name parameter in coolwsd.xml." : "此 URL 是在 Collabora 伺服器上從配置的 URL 或 coolwsd.xml 中的 server_name 參數確定的。",
    "Collabora Online server is reachable." : "可連線至 Collabora Online 伺服器。",
    "URL used by the browser:" : "瀏覽器使用的URL：",
    ...
    "Enable if your Collabora Online server uses a self signed certificate" : "如果您的 Collabora Online 伺服器使用自簽名證書，請啟用此選項。",
    ...
    "it is unreachable from the internet (possibly because of a firewall, or lack of port forwarding)" : "無法透過互聯網聯繫到（可能是防火牆或缺少端口轉發的關繫）",
    ...
    "All users can edit documents with {productName} by default. When this setting is active, only the members of the specified groups can edit, whereas the others can only view documents." : "默認情況下，所有用戶都可以使用 {productName} 編輯文件。當此設置處於活動狀態時，只有指定組的成員可以編輯，其他人只能查看文件。",
    ...
    "Secure View" : "安全檢視",
    "Secure view enables you to secure office documents by blocking downloads, previews and showing a watermark" : "安全視圖可讓您通過阻止下載、預覽和顯示水印來保護辦公文件",
    ...
    "Downloading the file through WebDAV will be blocked" : "將會阻止通過 WebDAV 下載該檔案",
    ...
    "Previews will be blocked" : "預覽將被阻止",
    ...
    "Enforce secure view on tagged files" : "在已標記的檔案上實施安全檢視",
    "Select tags to enforce watermarking" : "選擇要實施加上水印的標籤",
    "Enforce secure view for users of groups" : "對群組的用戶實施安全檢視",
    "Enforce secure view for all shares" : "對所有分享實施安全檢視",
    "Enforce secure view for read only shares" : "對唯讀分享實施安全檢視",
    "Enforce secure view for all public Talk shares" : "對所有公共 Talk 分享實施安全檢視",
    "Enforce secure view for shares without download permission" : "對沒有下載許可的分享實施安全檢視",
    "Enforce secure view for all link shares" : "對所有連結分享實施安全檢視",
    "Enforce secure view for download hidden shares" : "對所有下載隱藏分享實施安全檢視",
    "Enforce secure view for read only link shares" : "對唯讀連結分享實施安全檢視",
    "Enforce secure view on link shares with specific system tags" : "對具有特定系統標籤的連結分享實施安全檢視",
    "Select tags to enforce secure view" : "選擇標籤以實施安全檢視",
    ...
    "File name" : "檔案名稱",
    "Create" : "建立",
    "Failed to set Zotero API key" : "設定 Zotero API 密鑰失敗",
    "Link to your Zotero library" : "連結至 Zotero 媒體庫",
    "Connect your Zotero account to make use of references within Office." : "連接您的 Zotero 帳戶以在 Office 中進行引用。",
    "You can generate an account key here:" : "您可以在此產生帳戶密鑰：",
    "Zotero account settings" : "Zotero 帳戶設定",
    "Zotero API key" : "Zotero API 密鑰",
    "Submit" : "遞交",
    ...
    "Enter document signing key" : "輸入文件簽署密鑰",
    "Enter document signing CA chain" : "輸入文件簽署 CA 鏈",
    "To use document signing, specify your signing certificate, key and CA chain here." : "要使用文件簽署，請在此處指定您的簽署憑證、密鑰與 CA 鏈。",
    "This instance does not support document signing, because the feature is missing or disabled. Please contact the administrator." : "此實例不支援文件簽署，因為缺少功能或已停用。請聯絡管理員。",
    "Description" : "描述",
    ...
    "Cluster is scaling …" : "集群正在進行擴展 ...",
    "The collaborative editing was terminated by another user" : "協作編輯被另一個用戶終止",
    "Document loading failed" : "文件加載失敗",
    "Please check the Collabora Online server log for more details and make sure that Nextcloud can be reached from there." : "請檢查 Collabora Online 伺服器記錄以獲取更多詳細資訊，並確保 Nextcloud 可以從該伺服器連接。",
