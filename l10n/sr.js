OC.L10N.register(
    ...
    "Saved" : "Сачувано",
    "Saved with error: Office Online should use the same protocol as the server installation." : "Сачувану уз грешку: Office Online би требало да користи исти протокол као и серверска инсталација.",
    ...
    "This application can connect to a Office Online (or other) server (WOPI-like Client). Nextcloud is the WOPI Host. Please read the documentation to learn more about that." : "Ова апликација може да се повеже са Office Online (или другим) сервером (WOPI клијент). Некстклауд је WOPI домаћин. Прочитајте документацију да сазнате више.",
    ...
    "Office Online is a powerful LibreOffice-based online office suite with collaborative editing, which supports all major documents, spreadsheet and presentation file formats and works together with all modern browsers." : "Office Online је моћни канцеларијски пакет базиран на LibreOffice-у са могућношћу заједничком уређивања. Подржани су сви главни типови  формата фајлова докумената, табела и презентација, а ради из свих модерних веб читача.",
    "URL (and Port) of Office Online-server" : "Адреса (и порт) Office Online сервера",
    "Apply" : "Примени",
    "Office Online requires a seperate server acting as a WOPI-like Client to provide editing capabilities." : "Office Online захтева посебан сервер који се понаша као WOPI-Client да бисте добили могућност уређивања.",
    "Disable certificate verification (insecure)" : "Искључи проверу сертификата (небезбедно)",
    "Enable if your Office Online server uses a self signed certificate" : "Укључите ако Ваш Office Online сервер користи самопотписани сертификат",
    "Restrict usage to specific groups" : "Ограничи коришћење на одређене групе",
    "Office Online is enabled for all users by default. When this setting is active, only members of the specified groups can use it." : "Office Online је укључена подразумевано за све кориснике. Када је ово подешавање укључено, само чланови означених група је могу користити.",
    "Restrict edit to specific groups" : "Ограничи могућност мењања на одређене групе",
    "All users can edit documents with Office Online by default. When this setting is active, only the members of the specified groups can edit and the others can only view documents." : "Office Online је укључена подразумевано за све кориснике. Када је ово подешавање укључено, само чланови означених група је могу користити, а остали могу само да прегледају документе.",
    ...
    "Templates inside of this directory will be added to the template selector of Office Online." : "Шаблони унутар овог директоријума ће бити додати у Office-ин одабирач шаблона.",
