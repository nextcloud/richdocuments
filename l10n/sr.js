OC.L10N.register(
    ...
    "Edit with Collabora online" : "Уреди помоћу Collabora online",
    ...
    "All users can edit documents with Collabora Online by default. When this setting is active, only the members of the specified groups can edit and the others can only view documents." : "Collabora Online је укључена подразумевано за све кориснике. Када је ово подешавање укључено, само чланови означених група је могу користити, а остали могу само да прегледају документе.",
