OC.L10N.register(
    ...
    "Saved" : "Lagret",
    "Saved with error: Office Online should use the same protocol as the server installation." : "Lagret med feil: Office Online bør bruke samme protokoll som serverinstallasjonen.",
    ...
    "Canonical webroot, in case there are multiple, for Office to use. Provide the one with least restrictions. Eg: Use non-shibbolized webroot if this instance is accessed by both shibbolized and non-shibbolized webroots. You can ignore this setting if only one webroot is used to access this instance." : "Foretrukket nettrot (webroot) - i tilfelle Office kan bruke flere. Velg den med minst restriksjoner. Merk: Bruk ikke-shibbolert nettrot dersom du har flere. Du kan ignorere denne innstillingen om du kun bruker en nettrot (webroot).",
