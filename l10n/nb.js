OC.L10N.register(
    "richdocuments",
    {
    "No files found for this task." : "Ingen filer funnet for denne oppgaven.",
    ...
    "Saved" : "Lagret",
    "Invalid config key" : "Ugyldig konfigurasjonsnøkkel",
    "Error when saving" : "Feil under lagring",
    ...
    "Failed to upload the file" : "Opplasting av filen feilet",
    ...
    "Unable to determine the proper file extension for %1$s" : "Kunne ikke bestemme riktig filtype for %1$s",
    "Unable to fetch information on %1$s" : "Kunne ikke hente informasjon på %1$s",
    "PDF (.pdf)" : "PDF (.pdf)",
    "Image (.png)" : "Bilde (.png)",
    "Image (.svg)" : "Bilde (.svg)",
    "Text (.rtf)" : "Text (.rtf)",
    ...
    "Excel Workbook (.xlsx)" : "Excel-arbeidsbok (.xlsx)",
    "OpenDocument Spreadsheet (.ods)" : "OpenDocument-regneark (.ods)",
    "PowerPoint Presentation (.pptx)" : "PowerPoint-presentasjon (.pptx)",
    "OpenDocument Presentation (.odp)" : "OpenDocument-presentasjon (.odp)",
    "New document" : "Nytt dokument",
    "New spreadsheet" : "Nytt regneark",
    "New presentation" : "Ny presentasjon",
    "New diagram" : "Nytt diagram",
    "{user} has mentioned you in {node}" : "{user} har nevnt deg i {node}",
    ...
    "Slides" : "Lysbilder",
    "Office" : "Office",
    "Presentation script" : "Manus",
    "Write the text for your presentation here" : "Skriv teksten for presentasjonen din her",
    "Nextcloud Office text document generator" : "Nextcloud Office-tekstdokumentgenerator",
    "Document format" : "Dokumentformat",
    "The format of the generated document" : "Formatet til det genererte dokumentet",
    ...
    "Generate an Office text document from a prompt" : "Generer et Office-tekstdokument fra en prompt",
    "Instructions" : "Instruksjoner",
    "Describe the document you want the assistant to generate" : "Beskriv dokumentet du ønsker at assistenten skal generere",
    "Generated Office document" : "Generert Office-dokument",
    "The Office document that was generated from the description" : "Office-dokumentet som ble generert fra beskrivelsen",
    "Nextcloud Office spreadsheet generator" : "Nextcloud Office-regnearkgenerator",
    "OpenXML (xlsx)" : "OpenXML (xlsx)",
    "OpenDocument (ods)" : "OpenDocument (ods)",
    "Generate Office spreadsheet document" : "Generer Office-regneark",
    "Generate an Office spreadsheet document from a prompt" : "Generer et Office-regnark fra en prompt",
    "Empty" : "Tom",
    ...
    "Deleted template" : "Slettet mal",
    "Global Templates" : "Globale maler",
    "New" : "Ny",
    "Contact {0} to get an own installation." : "Kontakt {0} for å få en egen installasjon.",
    "Make sure to set this URL: {url} in the coolwsd.xml file of your Collabora Online server to ensure the added fonts get loaded automatically. Please note that http:// will only work for debug builds of Collabora Online. In production you must use https:// for remote font config." : "Sørg for å angi denne URL-adressen: {url} i coolwsd.xml-filen på Collabora Online-serveren for å sikre at skrifttypene som legges til lastes inn automatisk. Vær oppmerksom på at http:// bare virker for feilsøkingsversjoner av Collabra Online. I produksjon må du bruke https:// for ekstern skrifttypekonfigurasjon.",
    ...
    "Custom Fonts" : "Egendefinerte skrifttyper",
    "Upload font file" : "Last opp skrifttypefil",
    "Upload a font file" : "Last opp en skriftfil",
    "Available fonts" : "Tilgjengelige skrifttyper",
    ...
    "Custom fonts documentation" : "Dokumentasjon for egendefinerte skrifter",
    "Secure View" : "Sikker visning",
    "Secure view enables you to secure office documents by blocking downloads, previews and showing a watermark" : "Sikker visning gjør det mulig å sikre Office-dokumenter ved å blokkere nedlastinger, forhåndsvisninger, og vannmerkevisning ",
    ...
    "Downloading the file through WebDAV will be blocked" : "Nedlasting gjennom WebDAV vil bli blokkert",
    ...
    "Previews will be blocked" : "Forhåndsvisninger vil bli blokkert",
    "Enable secure view" : "Aktiver sikker visning",
    "Supported placeholders: {userId}, {userDisplayName}, {email}, {date}, {themingName}" : "Støttede plassholdere: {brukerId}, {brukervisningsnavn}, {e-post}, {dato}, {temanavn}",
    "Enforce secure view on tagged files" : "Påtving sikker visning for taggede filer",
    "Select tags to enforce watermarking" : "Velg tagger for å fremtvinge vannmerking",
    "Enforce secure view for users of groups" : "Påtving sikker visning for brukere i grupper",
    "Enforce secure view for all shares" : "Påtving sikker visning for alle delinger",
    "Enforce secure view for read only shares" : "Påtving sikker visning for skrivebeskyttede delinger",
    "Enforce secure view for all public Talk shares" : "Påtving sikker visning for alle offentlige Samtale-delinger",
    "Enforce secure view for shares without download permission" : "Påtving sikker visning for delinger uten nedlastingstillatelse",
    "Enforce secure view for all link shares" : "Påtving sikker visning for alle lenkedelinger",
    "Enforce secure view for read only link shares" : "Påtving sikker visning for skrivebeskyttede lenkedelinger",
    "Enforce secure view on link shares with specific system tags" : "Påtving sikker visning for lenkedelinger med spesifikke systemmerkninger",
    "Select tags to enforce secure view" : "Velg tagger for å påtvinge sikker visning",
    "Electronic Signature" : "Elektronisk signatur",
    "Client ID for the electronic signature API" : "Klient-ID til API-et for elektronisk signatur",
    "Fill in the registration form at https://eideasy.com/signup to obtain a client ID and secret." : "Fyll inn registreringsskjemaet på https://eideasy.com/signup for å få en klient-ID og hemmelig nøkkel.",
    "Secret for the electronic signature API" : "Hemmelig nøkkel for elektronisk signatur API",
    "Save" : "Lagre",
    "Remove" : "Fjern",
    ...
    "Personal Settings for Nextcloud Office" : "Personlige innstillinger for Nextcloud Office",
    ...
    "Enter document signing cert (in PEM format)" : "Skriv inn sertifikat for dokumentsignering (i PEM format)",
    "Enter document signing key" : "Skriv inn sertifikat for dokumentsignering",
    "Enter document signing CA chain" : "Skriv inn CA-kjeden for dokumentsignering",
    "To use document signing, specify your signing certificate, key and CA chain here." : "For å bruke dokumentsignering, angi sertifikat, nøkkel, og CA-kjede her.",
    "This instance does not support document signing, because the feature is missing or disabled. Please contact the administrator." : "Denne instansen støtter ikke dokumentsignering, fordi funksjonen mangler eller er deaktivert. Vennligst kontakt administratoren.",
    "Description" : "Beskrivelse",
    "Add new token" : "Legg til nytt token",
    ...
    "Insert into document" : "Sett inn i dokument",
    ...
    "Insert file from {name}" : "Sett inn fil fra {name}",
    ...
    "Guest" : "Gjest",
    "Follow current editor" : "Følg nåværende redigeringsprogram",
    "New file" : "Ny fil",
    "Please enter the filename for the new file" : "Vennligst skriv inn filnavnet for den nye filen",
    ...
    "Secure view settings" : "Sikre visningsinnstillinger",
    ...
    "Enable watermarking" : "Aktiver vannmerking",
    ...
    "Collabora Online is not setup yet. Please contact your administrator." : "Collabora Online er ikke satt opp enda. Vennligst kontakt din administrator.",
    "Opening the file is not supported, since the credentials for the external storage are not available without a session" : "Åpning av filen er ikke søttet, fordi legitimasjonen for ekstern lagring er ikke tilgjengelig uten en sesjon.",
    ...
    "Saving…" : "Lagrer…",
    "Insert from {name}" : "Sett inn fra {name}",
    "Last saved version" : "Sist lagret versjon",
    "Current version (unsaved changes)" : "Gjeldende versjon (ulagrede endringer)",
    "Please enter the filename for the new document" : "Vennligst skriv inn filnavnet for det nye dokumentet",
