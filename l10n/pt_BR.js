OC.L10N.register(
    ...
    "This application can connect to a Office Online (or other) server (WOPI-like Client). Nextcloud is the WOPI Host. Please read the documentation to learn more about that." : "Este aplicativo pode se conectar a um servidor Office Online ou outro cliente semelhante ao WOPI). Nextcloud é o anfitrião WOPI. Por favor, leia a documentação para saber mais sobre isso.",
    ...
    "Enable if your Office Online server uses a self signed certificate" : "Ativar se o seu servidor Office Online usar um certificado auto assinado",
    ...
    "All users can edit documents with Office Online by default. When this setting is active, only the members of the specified groups can edit and the others can only view documents." : "Todos os usuários podem editar documentos com o Office Online por padrão. Quando essa configuração está ativa, somente os membros dos grupos especificados podem editar e os outros só podem visualizar documentos.",
