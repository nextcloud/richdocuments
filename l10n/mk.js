OC.L10N.register(
    ...
    "Failed to upload the file" : "Неуспешно прикачување на датотека",
    ...
    "Extra fonts" : "Екстра фонтови",
    "Upload extra font file" : "Прикачи екстра фонт датотека",
    "Upload a font file" : "Прикачи нов фонт",
    "Available fonts" : "Достапни фонтови",
    ...
    "Continue editing online" : "Продолжи со измените онлајн",
    ...
    "Open with {productName}" : "Отвори со {productName}",
    ...
    "Current version (unsaved changes)" : "Моментална верзија (незачувани промени)",
