OC.L10N.register(
    ...
    "This application can connect to a Office Online (or other) server (WOPI-like Client). Nextcloud is the WOPI Host. Please read the documentation to learn more about that." : "Оваа апликација може да се поврзе со Office Online (или други) сервер (WOPI како клиент). Nextcloud е WOPI домаќин. Прочитајте ја документацијата за да дознаете повеќе за тоа.",
