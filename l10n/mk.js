OC.L10N.register(
    ...
    "All users can edit documents with Collabora Online by default. When this setting is active, only the members of the specified groups can edit and the others can only view documents." : "Стандардно сите корисници можат да уредуваат документи со Collabora Online. Кога овој параметар е активен, само членови на одредени рупи можат да уредуваат а останатите можат само да ги прегледуваат документите.",
