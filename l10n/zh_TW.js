OC.L10N.register(
    ...
    "Conversion is unavailable for this file." : "此檔案無法進行轉換。",
    "Conversion is blocked because the file is protected by Secure View." : "因為檔案受安全檢視保護，因此無法轉換。",
    ...
    "This document was generated using Artificial Intelligence" : "此文件由人工智慧產生",
    "Headings" : "標題",
    "Sections" : "區塊",
    "Images" : "圖片",
    "Sheets" : "工作表",
    "Slides" : "投影片",
    "Generated using Artificial Intelligence" : "使用人工智慧產生",
    "Office" : "Office",
    ...
    "Nextcloud Office (Collabora) text document generator" : "Nextcloud Office (Collabora) 文字文件產生器",
    ...
    "Nextcloud Office (Collabora) spreadsheet generator" : "Nextcloud Office (Collabora) 試算表產生器",
    ...
    "Instance-wide templates that should be available to all users." : "應提供給所有使用者的站台全域範本。",
    ...
    "Nextcloud Office (Collabora) requires a separate server running Collabora Online to provide editing capabilities." : "Nextcloud Office (Collabora) 需要一台執行 Collabora Online 的獨立伺服器來提供編輯功能。",
    ...
    "The settings only apply to compatible office files that are opened in Nextcloud Office (Collabora)" : "該設定僅適用於在 Nextcloud Office (Collabora) 中開啟的相容 office 檔案",
    "Downloading the file through WebDAV will be blocked" : "將會阻止透過 WebDAV 下載檔案",
    "The following options within Nextcloud Office (Collabora) will be disabled: Copy, Download, Export, Print" : "Nextcloud Office (Collabora) 中的以下選項將被停用：複製、下載、匯出、列印",
    ...
    "Personal Settings for Nextcloud Office (Collabora)" : "Nextcloud Office (Collabora) 的個人設定",
    "Select a template directory" : "選取範本目錄",
    "Remove personal template folder" : "移除個人範本資料夾",
    "Templates inside of this directory will be added to the template selector of Nextcloud Office (Collabora)." : "此目錄內的範本將會被新增至 Nextcloud Office (Collabora) 的範本選擇器中。",
    ...
    "Preview" : "預覽",
    "Edit" : "編輯",
    "Starting the built-in CODE server …" : "啟動內建的 CODE 伺服器……",
    ...
    "Starting the built-in CODE server is taking longer than expected" : "啟動內建的 CODE 伺服器所花費的時間比預期更長",
