OC.L10N.register(
    ...
    "Saved" : "Konservita",
    "Saved with error: Office Online should use the same protocol as the server installation." : "Konservita kun eraro: „Office Online“ devus uzi la saman protokolon kiel la servil-instalaĵo.",
    ...
    "This application can connect to a Office Online (or other) server (WOPI-like Client). Nextcloud is the WOPI Host. Please read the documentation to learn more about that." : "Tiu ĉi aplikaĵo povas konekti al servilo „Office Online“ aŭ alia (WOPI-kliento). Nextcloud estas la WOPI-gastiganto. Legu la dokumentaron por scii pli pri tio.",
    ...
    "Office Online is a powerful LibreOffice-based online office suite with collaborative editing, which supports all major documents, spreadsheet and presentation file formats and works together with all modern browsers." : "Office Online estas reta oficeja programaro, bazita sur LibreOffice, kiu subtenas kunlaboran redakton, ĉiujn ĉefajn dosiertipojn de dokumentoj, kalkultabeloj kaj lumbildaj prezentoj. Ĝi funkcias kun ĉiuj nunaj retumiloj.",
    "URL (and Port) of Office Online-server" : "Retadreso (kaj pordo) de „Office Online“-servilo",
    "Apply" : "Apliki",
    "Office Online requires a seperate server acting as a WOPI-like Client to provide editing capabilities." : "Office Online bezonas apartan servilon, kiu estas „WOPI“-kliento provizanta redaktan eblecon.",
    "Disable certificate verification (insecure)" : "Ne kontroli atestilon (nesekura)",
    "Enable if your Office Online server uses a self signed certificate" : "Ŝalti tion, se via servilo „Office Online“ uzas memsubskribitan atestilon",
    "Restrict usage to specific groups" : "Limigi uzon al certaj grupoj",
    "Office Online is enabled for all users by default. When this setting is active, only members of the specified groups can use it." : "Office Online uzeblas de ĉiuj uzantoj defaŭlte. Uzante tiun agordon, vi povas limigi al elektitaj grupoj.",
    "Restrict edit to specific groups" : "Limigi redakton al certaj grupoj",
    "All users can edit documents with Office Online by default. When this setting is active, only the members of the specified groups can edit and the others can only view documents." : "Ĉiuj uzantoj povas defaŭlte modifi dokumentojn per Office Online. Kiam tiu agordo uziĝas, nur anoj de la elektitaj grupoj povas modifi, kaj la aliaj uzantoj povas nur vidi la dokumentojn.",
    ...
    "Templates inside of this directory will be added to the template selector of Office Online." : "Ŝablonoj en tiu ĉi dosierujo estos aldonita al la ŝablona elektilo de „Office Online“.",
