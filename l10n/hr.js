OC.L10N.register(
    ...
    "This application can connect to a Collabora Online server (WOPI Client). Nextcloud is the WOPI Host. Please read the documentation to learn more about that." : "Ova se aplikacija može povezati s poslužiteljem Collabora Online (WOPI klijent). Nextcloud je domaćin za WOPI. Pročitajte dokumentaciju za više informacija.",
    ...
    "Apply" : "Potvrdi",
    "Collabora Online requires a seperate server acting as a WOPI-Client to provide editing capabilities." : "Collabora Online zahtijeva poseban poslužitelj koji djeluje kao WOPI-klijent kako bi osigurao mogućnost uređivanja.",
