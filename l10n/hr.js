OC.L10N.register(
    ...
    "Saved" : "Spremljeno",
    "Saved with error: Office Online should use the same protocol as the server installation." : "Spremljeno s pogreškom: Office Online treba koristiti isti protokol kao i instalacija poslužitelja.",
    ...
    "This application can connect to a Office Online (or other) server (WOPI-like Client). Nextcloud is the WOPI Host. Please read the documentation to learn more about that." : "Ova se aplikacija može povezati s poslužiteljem Office Online (ili drugim) (WOPI ili sličan klijent). Nextcloud je domaćin za WOPI. Pročitajte dokumentaciju za više informacija.",
    ...
    "Office Online is a powerful LibreOffice-based online office suite with collaborative editing, which supports all major documents, spreadsheet and presentation file formats and works together with all modern browsers." : "Office Online moćan je mrežni uredski paket temeljen na paketu LibreOffice s kolaborativnim uređivanjem koji podržava sve glavne formate dokumenata, proračunskih tablica i prezentacijskih datoteka te podržava sve moderne preglednike.",
    "URL (and Port) of Office Online-server" : "URL (i port) poslužitelja Office Online",
    "Apply" : "Potvrdi",
    "Office Online requires a seperate server acting as a WOPI-like Client to provide editing capabilities." : "Office Online zahtijeva poseban poslužitelj koji djeluje kao WOPI ili sličan klijent kako bi osigurao mogućnost uređivanja.",
    "Disable certificate verification (insecure)" : "Onemogući provjeru vjerodajnice (nesigurno)",
    "Enable if your Office Online server uses a self signed certificate" : "Omogući ako poslužitelj Office Online koristi vjerodajnicu koju sam potpisuje",
    "Restrict usage to specific groups" : "Ograniči uporabu na određene grupe",
    "Office Online is enabled for all users by default. When this setting is active, only members of the specified groups can use it." : "Office Online je prema zadanim postavkama omogućen za sve korisnike. Kad je ova postavka aktivna, mogu je koristiti samo pripadnici određenih grupa.",
    "Restrict edit to specific groups" : "Ograniči uređivanje na određene grupe",
    "All users can edit documents with Office Online by default. When this setting is active, only the members of the specified groups can edit and the others can only view documents." : "Svi korisnici mogu prema zadanim postavkama uređivati dokumente s pomoću platforme Office Online. Kada je ova postavka aktivna, samo članovi određenih grupa mogu uređivati dokumente, a ostali mogu samo pregledavati dokumente.",
    ...
    "Canonical webroot, in case there are multiple, for Office to use. Provide the one with least restrictions. Eg: Use non-shibbolized webroot if this instance is accessed by both shibbolized and non-shibbolized webroots. You can ignore this setting if only one webroot is used to access this instance." : "Office može koristiti Canonical webroot u slučaju da ih je više. Omogućite onaj s najmanje ograničenja. Npr.: koristite non-shibbolized webroot ako ovoj instanci pristupaju i shibbolized i non-shibbolized webrootovi. Možete zanemariti ovu postavku ako se za pristup ovoj instanci koristi samo jedan webroot.",
    ...
    "Templates inside of this directory will be added to the template selector of Office Online." : "Predlošci unutar ove mape bit će dodani u birač predložaka platforme Office Online.",
    "Wrong password. Please retry." : "Pogrešna zaporke. Pokušajte ponovno.",
    "Password" : "Zaporka",
    "OK" : "U redu",
    "Guest %s" : "Gost %s",
    "This link has been expired or is never existed. Please contact the person who shared it with you for details." : "Ova poveznica je istekla ili nikad nije postojala. Za više se informacija obratite osobi koja ju je s vama podijelila."
},
