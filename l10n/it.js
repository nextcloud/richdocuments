OC.L10N.register(
    ...
    "Extra fonts" : "Caratteri aggiuntivi",
    "Available fonts" : "Caratteri disponibili",
    ...
    "Zotero" : "Zotero",
    "Enter Zotero API Key" : "Digita la chiave API di Zotero",
    "Save Zotero API key" : "Salva la chiave API di Zotero",
    "Remove Zotero API Key" : "Rimuovi la chiave API di Zotero",
    "To use Zotero specify your API key here. You can create your API key in your" : "Per utilizzare Zotero, specifica qui la tua chiave API. Puoi creare la tua chiave API nel tuo",
    "Zotero account API settings." : "Impostazioni dell'API dell'account Zotero.",
    "This instance does not support Zotero, because the feature is missing or disabled. Please contact the administration." : "Questa istanza non supporta Zotero, perché la funzionalità è mancante o disabilitata. Contatta l'amministratore.",
