OC.L10N.register(
    ...
    "This application can connect to a Office Online (or other) server (WOPI-like Client). Nextcloud is the WOPI Host. Please read the documentation to learn more about that." : "Tato aplikace se dokáže připojit ke Office Online (nebo jinému) serveru (jako WOPI Client). Nextcloud se chová jako WOPI Host. Prosím projděte si dokumentaci k tomuto tématu.",
    ...
    "Enable if your Office Online server uses a self signed certificate" : "Zapněte pokud používaný server Office Online používá sám sebou podepsaný certifikát",
    ...
    "All users can edit documents with Office Online by default. When this setting is active, only the members of the specified groups can edit and the others can only view documents." : "Ve výchozím stavu mohou v Office Online upravovat dokumenty všichni uživatelé. Pokud je toto nastavení aktivní, pouze členové zadaných skupiny mohou upravovat a ostatní mohou dokumenty pouze prohlížet.",
