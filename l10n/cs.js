OC.L10N.register(
    ...
    "This document was generated using Artificial Intelligence" : "Tento dokument byl vytvořen s použitím umělé inteligence",
    "Headings" : "Nadpisy",
    "Sections" : "Sekce",
    "Images" : "Obrázky",
    "Sheets" : "Listy",
    "Slides" : "Stránky prezentace",
    "Generated using Artificial Intelligence" : "Vytvořeno s použitím umělé inteligence",
    "Office" : "Kancelář",
    ...
    "Instance-wide templates that should be available to all users." : "Šablony platné pro celou instanci které mají být k dispozici všem uživatelům.",
    ...
    "Cancel" : "Storno",
    "Save As" : "Uložit jako",
    "A file with that name already exists." : "Soubor s takovým názvem už existuje.",
    "Error checking if file exists." : "Chyba při zjišťování zda soubor existuje.",
    "Save as" : "Uložit jako",
