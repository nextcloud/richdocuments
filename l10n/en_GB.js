OC.L10N.register(
    "richdocuments",
    {
    "No files found for this task." : "No files found for this task.",
    ...
    "Conversion is unavailable for this file." : "Conversion is unavailable for this file.",
    "Conversion is blocked because the file is protected by Secure View." : "Conversion is blocked because the file is protected by Secure View.",
    ...
    "This document was generated using Artificial Intelligence" : "This document was generated using Artificial Intelligence",
    "Headings" : "Headings",
    "Sections" : "Sections",
    "Images" : "Images",
    "Sheets" : "Sheets",
    "Slides" : "Slides",
    "Generated using Artificial Intelligence" : "Generated using Artificial Intelligence",
    "Office" : "Office",
    "Nextcloud Assistant Slide Deck Generator" : "Nextcloud Assistant Slide Deck Generator",
    "Generate Slide Deck" : "Generate Slide Deck",
    "Generate a slide deck from a presentation script" : "Generate a slide deck from a presentation script",
    "Presentation script" : "Presentation script",
    "Write the text for your presentation here" : "Write the text for your presentation here",
    "Generated slide deck" : "Generated slide deck",
    "The slide deck generated" : "The slide deck generated",
    "Nextcloud Office (Collabora) text document generator" : "Nextcloud Office (Collabora) text document generator",
    "Document format" : "Document format",
    "The format of the generated document" : "The format of the generated document",
    "OpenXML (docx)" : "OpenXML (docx)",
    "OpenDocument (odt)" : "OpenDocument (odt)",
    "Portable Document Format (pdf)" : "Portable Document Format (pdf)",
    "Generate Office text document" : "Generate Office text document",
    "Generate an Office text document from a prompt" : "Generate an Office text document from a prompt",
    "Instructions" : "Instructions",
    "Describe the document you want the assistant to generate" : "Describe the document you want the assistant to generate",
    "Generated Office document" : "Generated Office document",
    "The Office document that was generated from the description" : "The Office document that was generated from the description",
    "Nextcloud Office (Collabora) spreadsheet generator" : "Nextcloud Office (Collabora) spreadsheet generator",
    "OpenXML (xlsx)" : "OpenXML (xlsx)",
    "OpenDocument (ods)" : "OpenDocument (ods)",
    "Generate Office spreadsheet document" : "Generate Office spreadsheet document",
    "Generate an Office spreadsheet document from a prompt" : "Generate an Office spreadsheet document from a prompt",
    "Empty" : "Empty",
    ...
    "Instance-wide templates that should be available to all users." : "Instance-wide templates that should be available to all users.",
    ...
    "Nextcloud Office (Collabora) requires a separate server running Collabora Online to provide editing capabilities." : "Nextcloud Office (Collabora) requires a separate server running Collabora Online to provide editing capabilities.",
    ...
    "Secure view enables you to secure office documents by blocking downloads, previews and showing a watermark" : "Secure view enables you to secure office documents by blocking downloads, previews and showing a watermark",
    "The settings only apply to compatible office files that are opened in Nextcloud Office (Collabora)" : "The settings only apply to compatible office files that are opened in Nextcloud Office (Collabora)",
    "Downloading the file through WebDAV will be blocked" : "Downloading the file through WebDAV will be blocked",
    "The following options within Nextcloud Office (Collabora) will be disabled: Copy, Download, Export, Print" : "The following options within Nextcloud Office (Collabora) will be disabled: Copy, Download, Export, Print",
    ...
    "Previews will be blocked" : "Previews will be blocked",
    ...
    "Enforce secure view on tagged files" : "Enforce secure view on tagged files",
    "Select tags to enforce watermarking" : "Select tags to enforce watermarking",
    "Enforce secure view for users of groups" : "Enforce secure view for users of groups",
    "Enforce secure view for all shares" : "Enforce secure view for all shares",
    "Enforce secure view for read only shares" : "Enforce secure view for read only shares",
    "Enforce secure view for all public Talk shares" : "Enforce secure view for all public Talk shares",
    "Enforce secure view for shares without download permission" : "Enforce secure view for shares without download permission",
    "Enforce secure view for all link shares" : "Enforce secure view for all link shares",
    "Enforce secure view for download hidden shares" : "Enforce secure view for download hidden shares",
    "Enforce secure view for read only link shares" : "Enforce secure view for read only link shares",
    "Enforce secure view on link shares with specific system tags" : "Enforce secure view on link shares with specific system tags",
    "Select tags to enforce secure view" : "Select tags to enforce secure view",
    ...
    "Error checking if file exists." : "Error checking if file exists.",
    "Save as" : "Save as",
    ...
    "Personal Settings for Nextcloud Office (Collabora)" : "Personal Settings for Nextcloud Office (Collabora)",
    "Select a template directory" : "Select a template directory",
    "Remove personal template folder" : "Remove personal template folder",
    "Templates inside of this directory will be added to the template selector of Nextcloud Office (Collabora)." : "Templates inside of this directory will be added to the template selector of Nextcloud Office (Collabora).",
    ...
    "Preview" : "Preview",
    "Edit" : "Edit",
    "Starting the built-in CODE server …" : "Starting the built-in CODE server …",
    ...
    "Starting the built-in CODE server is taking longer than expected" : "Starting the built-in CODE server is taking longer than expected",
