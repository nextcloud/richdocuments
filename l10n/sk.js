OC.L10N.register(
    ...
    "Conversion is unavailable for this file." : "Konverzia pre tento súbor nie je k dispozícii.",
    "Conversion is blocked because the file is protected by Secure View." : "Konverzia je zablokovaná, pretože súbor je chránený funkciou Secure View.",
    ...
    "This document was generated using Artificial Intelligence" : "Tento dokument bol vygenerovaný pomocou umelej inteligencie",
    "Headings" : "Nadpisy",
    "Sections" : "Sekcie",
    "Images" : "Obrázky",
    "Sheets" : "Tabuľky",
    "Slides" : "Prezentácie",
    "Generated using Artificial Intelligence" : "Vygenerované pomocou umelej inteligencie",
    "Office" : "Office",
    "Nextcloud Assistant Slide Deck Generator" : "Nextcloud Assistant Generátor prezentácií",
    "Generate Slide Deck" : "Vytvoriť prezentáciu",
    "Generate a slide deck from a presentation script" : "Vytvorte prezentáciu zo skriptu prezentácie",
    "Presentation script" : "Skript prezentácie",
    "Write the text for your presentation here" : "Napíšte text pre svoju prezentáciu sem",
    "Generated slide deck" : "Vygenerovaná prezentácia",
    "The slide deck generated" : "Prezentácia vytvorená",
    "Nextcloud Office (Collabora) text document generator" : "Generátor textových dokumentov Nextcloud Office (Collabora)",
    "Document format" : "Formát dokumentu",
    "The format of the generated document" : "Formát vygenerovaného dokumentu",
    "OpenXML (docx)" : "OpenXML (docx)",
    "OpenDocument (odt)" : "OpenDocument (odt)",
    "Portable Document Format (pdf)" : "Prenosný formát dokumentu (pdf)",
    "Generate Office text document" : "Vytvoriť textový dokument Office",
    "Generate an Office text document from a prompt" : "Vytvoriť textový dokument Office z promptu",
    "Instructions" : "Postup",
    "Describe the document you want the assistant to generate" : "Opíšte dokument, ktorý chcete, aby asistent vytvoril.",
    "Generated Office document" : "Vygenerovaný dokument Office",
    "The Office document that was generated from the description" : "Dokument Office, ktorý bol vygenerovaný z popisu",
    "Nextcloud Office (Collabora) spreadsheet generator" : "Generátor tabuliek Nextcloud Office (Collabora)",
    "OpenXML (xlsx)" : "OpenXML (xlsx)",
    "OpenDocument (ods)" : "OpenDocument (ods)",
    "Generate Office spreadsheet document" : "Vytvoriť dokument tabuľkového procesora Office",
    "Generate an Office spreadsheet document from a prompt" : "Vytvorte dokument tabuľkového procesora Office z výzvy",
    "Empty" : "Prázdny",
    ...
    "Instance-wide templates that should be available to all users." : "Šablóny platné pre celú inštanciu, ktoré by mali byť dostupné všetkým používateľom.",
    ...
    "Nextcloud Office (Collabora) requires a separate server running Collabora Online to provide editing capabilities." : "Nextcloud Office (Collabora) vyžaduje na poskytovanie funkcií úprav samostatný server s Collabora Online.",
    ...
    "Enable if your Collabora Online server uses a self signed certificate" : "Povoliť, ak váš server Collabora Online používa samopodpísaný certifikát.",
    ...
    "Secure view enables you to secure office documents by blocking downloads, previews and showing a watermark" : "Zabezpečený zobrazenie vám umožňuje zabezpečiť kancelárske dokumenty tým, že blokuje stiahnutie, náhľady a zobrazuje vodoznak.",
    "The settings only apply to compatible office files that are opened in Nextcloud Office (Collabora)" : "Nastavenia sa vzťahujú iba na kompatibilné kancelárske súbory otvorené v Nextcloud Office (Collabora)",
    "Downloading the file through WebDAV will be blocked" : "Sťahovanie súboru cez WebDAV bude zablokované",
    "The following options within Nextcloud Office (Collabora) will be disabled: Copy, Download, Export, Print" : "Nasledujúce možnosti v Nextcloud Office (Collabora) budú zakázané: Kopírovanie, sťahovanie, export, tlač",
    ...
    "Previews will be blocked" : "Náhľady budú zablokované",
    "Enable secure view" : "Povoliť bezpečný náhľad",
    ...
    "Enforce secure view on tagged files" : "Vynútiť bezpečný prístup k označeným súborom",
    "Select tags to enforce watermarking" : "Vyberte štítky na vynútenie vodoznaku",
    "Enforce secure view for users of groups" : "Vynútiť bezpečný zobrazenie pre používateľov skupín",
    "Enforce secure view for all shares" : "Vynútiť bezpečný náhľad pre všetky zdieľania",
    "Enforce secure view for read only shares" : "Vynútiť zabezpečený náhľad pre zdieľania iba na čítanie",
    "Enforce secure view for all public Talk shares" : "Vynútiť zabezpečený náhľad pre všetky verejné zdieľania v Talk",
    "Enforce secure view for shares without download permission" : "Vynútiť bezpečný režim pre zdieľania bez povolenia na stiahnutie",
    "Enforce secure view for all link shares" : "Vynútiť bezpečný náhľad pre všetky odkazy zdieľania",
    "Enforce secure view for download hidden shares" : "Vynútiť bezpečný náhľad pre stiahnutie skrytých zdieľaní",
    "Enforce secure view for read only link shares" : "Vynútiť zabezpečený náhľad pre zdieľania odkazu len na čítanie",
    "Enforce secure view on link shares with specific system tags" : "Vynútiť bezpečný náhľad pri zdieľaní odkazov so špecifickými systémovými štítkami",
    "Select tags to enforce secure view" : "Vyberte štítky na vynútenie zabezpečeného zobrazenia",
    ...
    "The secret is only sent to requests that can be verified to come from the Collabora server. Generate a WOPI proof key on the Collabora server or configure the WOPI allow list, otherwise electronic signatures stay unavailable." : "Tajný kľúč sa odosiela len požiadavkám, u ktorých je možné overiť, že pochádzajú zo servera Collabora. Na serveri Collabora vygenerujte WOPI overovací kľúč alebo nakonfigurujte WOPI allow list, inak zostanú elektronické podpisy nedostupné.",
    ...
    "Save As" : "Uložiť ako",
    "Save" : "Uložiť",
    "A file with that name already exists." : "Súbor s týmto názvom už existuje.",
    "Error checking if file exists." : "Pri kontrole existencie súboru sa vyskytla chyba.",
    "Save as" : "Uložiť ako",
    "Path to save" : "Cesta pre ukladanie",
    "Checking…" : "Kontroluje sa…",
    "Invalid file name" : "Neplatné meno súboru",
    "File name already exists" : "Názov súboru už existuje",
    ...
    "Personal Settings for Nextcloud Office (Collabora)" : "Osobné nastavenia pre Nextcloud Office (Collabora)",
    "Select a template directory" : "Vyberte priečinok šablón",
    "Remove personal template folder" : "Odstrániť osobný priečinok šablón",
    "Templates inside of this directory will be added to the template selector of Nextcloud Office (Collabora)." : "Šablóny v tomto adresári sa pridajú do výberu šablón v Nextcloud Office (Collabora).",
    "Description" : "Popis",
    ...
    "Preview" : "Náhľad",
    "Edit" : "Upraviť",
    "Starting the built-in CODE server …" : "Spúšťa sa vstavaný server CODE …",
    ...
    "Starting the built-in CODE server is taking longer than expected" : "Spúšťanie vstavaného servera CODE trvá dlhšie, než sa očakávalo",
    ...
    "Collabora Online is not setup yet. Please contact your administrator." : "Collabora Online ešte nebola nastavená. Kontaktujte svojho administrátora.",
    "Opening the file is not supported, since the credentials for the external storage are not available without a session" : "Otvorenie súboru nie je podporované, pretože prihlasovacie údaje pre externé úložisko nie sú dostupné bez relácie.",
