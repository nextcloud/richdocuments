OC.L10N.register(
    ...
    "This application can connect to a Office Online (or other) server (WOPI-like Client). Nextcloud is the WOPI Host. Please read the documentation to learn more about that." : "Esta aplicación pode conectarse a un servidor de Office Online ou outro (como cliente WOPI). Nextcloud é a máquina WOPI. Lea a documentación para obter máis información.",
    ...
    "Enable if your Office Online server uses a self signed certificate" : "Activar se o seu servidor de Office Online usa un certificado autoasinado",
    ...
    "All users can edit documents with Office Online by default. When this setting is active, only the members of the specified groups can edit and the others can only view documents." : "Todos os usuarios poden editar documentos con Office Online de xeito predeterminado. Cando esta configuración estea activa, só os membros dos grupos especificados poden editar e os demais só poden ver documentos.",
    ...
    "Canonical webroot, in case there are multiple, for Office to use. Provide the one with least restrictions. Eg: Use non-shibbolized webroot if this instance is accessed by both shibbolized and non-shibbolized webroots. You can ignore this setting if only one webroot is used to access this instance." : "Raíz web canónica, no caso de que haxa múltiples, para que use Office. Proporcione a que teña menos restricións. Ex.: Use a raíz web sen «shibboleth» se se accede a esta instancia tanto dende raíces web con «shibboleth» como sen «shibboleth». Pode ignorar este axuste se só se emprega unha raíz web para acceder a esta instancia.",
