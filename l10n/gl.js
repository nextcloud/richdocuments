OC.L10N.register(
    ...
    "Conversion is unavailable for this file." : "A conversión non está dispoñible para este ficheiro.",
    "Conversion is blocked because the file is protected by Secure View." : "A conversión está bloqueada porque o ficheiro está protexido por Secure View.",
    ...
    "This document was generated using Artificial Intelligence" : "Este documento foi xerado empregando intelixencia artificial.",
    "Headings" : "Títulos",
    "Sections" : "Seccións",
    "Images" : "Imaxes",
    "Sheets" : "Follas",
    "Slides" : "Diapositivas",
    "Generated using Artificial Intelligence" : "Xerado empregando intelixencia artificial",
    "Office" : "Oficina",
    ...
    "Nextcloud Office (Collabora) text document generator" : "Xerador de documentos de texto Nextcloud Office (Collabora)",
    ...
    "Nextcloud Office (Collabora) spreadsheet generator" : "Xerador de follas de cálculo Nextcloud Office (Collabora)",
    ...
    "Instance-wide templates that should be available to all users." : "Modelos de ámbito da instancia que deberían estar dispoñibles para todos os usuarios.",
    ...
    "Nextcloud Office (powered by Collabora Online) is a powerful online office suite with collaborative editing, which supports all major documents, spreadsheet and presentation file formats and works together with all modern browsers." : "Nextcloud Office (desenvolvido por Collabora Online) é unha suite de oficina en liña potente con edición colaborativa, que soporta tódolos formatos principais de documentos, follas de cálculo e presentacións e funciona con tódolos navegadores modernos.",
    ...
    "Nextcloud Office (Collabora) requires a separate server running Collabora Online to provide editing capabilities." : "Nextcloud Office (Collabora) require un servidor independente executando Collabora Online para proporcionar capacidades de edición.",
    ...
    "The settings only apply to compatible office files that are opened in Nextcloud Office (Collabora)" : "Os axustes só se aplican aos ficheiros de oficina compatibles que se abren en Nextcloud Office (Collabora)",
    "Downloading the file through WebDAV will be blocked" : "A descarga do ficheiro a través de WebDAV quedará bloqueada",
    "The following options within Nextcloud Office (Collabora) will be disabled: Copy, Download, Export, Print" : "As seguintes opcións dentro de Nextcloud Office (Collabora) desactivaranse: Copiar, Descargar, Exportar, Imprimir",
    ...
    "Cancel" : "Cancelar",
    "Save As" : "Gardar como",
    "A file with that name already exists." : "Xa existe un ficheiro con ese nome.",
    "Error checking if file exists." : "Produciuse un erro ao comprobar se existe o ficheiro",
    "Save as" : "Gardar como",
    ...
    "Personal Settings for Nextcloud Office (Collabora)" : "Axustes Persoais para Nextcloud Office (Collabora)",
    ...
    "Templates inside of this directory will be added to the template selector of Nextcloud Office (Collabora)." : "Os modelos dentro deste directorio serán engadidos ao selector de modelos de Nextcloud Office (Collabora).",
    ...
    "Starting the built-in CODE server is taking longer than expected" : "Iniciar o servidor CODE integrado está tardando máis do esperado",
