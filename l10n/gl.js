OC.L10N.register(
    ...
    "Nextcloud Office requires a separate server running Collabora Online to provide editing capabilities." : "Nextcloud Office require un servidor separado que execute Collabora Online para fornecer as funcións de edición.",
    "Collabora Online requires a separate server acting as a WOPI-like Client to provide editing capabilities." : "Collabora Online require un servidor separado que actúe como un cliente tipo WOPI para fornecer as funcións de edición.",
    ...
    "Upload extra font file" : "Cargar un ficheiro adicional de tipo de letra",
    "Upload a font file" : "Cargar un ficheiro de tipo de letra",
    ...
    "Show watermark for all link shares" : "Amosar a marca de auga en todas as ligazóns compartidas",
    "Show watermark for download hidden shares" : "Amosar a marca de auga na descarga de recursos compartidos agochados",
    ...
    "Failed to get a link with the picker" : "Non foi posíbel obter unha ligazón co selector",
    "Failed to get the link preview" : "Non foi posíbel obter a vista previa da ligazón",
    "Failed to connect to {productName}. Please try again later or contact your server administrator." : "Produciuse un fallo ao conectar con {productName}. Ténteo de novo máis adiante ou contacte coa administración do servidor.",
    ...
    "Nextcloud Office requires a seperate server running Collabora Online to provide editing capabilities." : "Nextcloud Office require un servidor separado que execute Collabora Online para fornecer as funcións de edición.",
