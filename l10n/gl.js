OC.L10N.register(
    ...
    "Link to your Zotero library" : "Ligazón á túa biblioteca de Zotero",
    "Connect your Zotero account to make use of references within Office." : "Conecta a túa conta de Zotero para facer uso das referencias de Office.",
    "You can generate an account key here:" : "Podes xerar unha clave da conta aquí:",
    "Zotero account settings" : "Configuración da conta de Zotero",
    "Zotero API key" : "Clave API de Zotero",
    "Submit" : "Enviar",
    "Failed to set Zotero API key" : "Produciuse un erro ao establecer a clave da API de Zotero",
