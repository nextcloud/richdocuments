OC.L10N.register(
    ...
    "Click here for more info" : "Щракнете тук за повече информация",
    ...
    "This instance does not support Zotero, because the feature is missing or disabled. Please contact the admin." : "Тази екземпляр не поддържа Zotero, тъй като функцията липсва или е деактивирана. Моля, свържете се с администратора.",
