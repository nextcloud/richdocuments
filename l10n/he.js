OC.L10N.register(
    ...
    "Saved" : "נשמר",
    "Saved with error: Office Online should use the same protocol as the server installation." : "נשמר עם שגיאה: Office Online צריך להשתמש באותו פרוטוקול של ההתקנה בשרת.",
    ...
    "Templates inside of this directory will be added to the template selector of Office Online." : "תבניות בתוך התיקייה הזאת יתווספו לבורר התבניות של Office Online.",
