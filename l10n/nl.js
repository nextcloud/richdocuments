OC.L10N.register(
    ...
    "This application can connect to a Office Online (or other) server (WOPI-like Client). Nextcloud is the WOPI Host. Please read the documentation to learn more about that." : "Deze applicatie kan verbinden met een Office Online server (WOPI-achtige Client). Nextcloud is de WOPI Host. Lees de documentatie voor meer informatie hierover.",
    ...
    "Enable if your Office Online server uses a self signed certificate" : "Inschakelen als je Office Online server self-signed certificaten gebruikt",
    ...
    "All users can edit documents with Office Online by default. When this setting is active, only the members of the specified groups can edit and the others can only view documents." : "Alle gebruikers kunnen met Office Online bestanden bewerken. Als deze instelling actief is, kunnen alleen leden van de opgegeven groep bewerken en alle anderen alleen lezen.",
