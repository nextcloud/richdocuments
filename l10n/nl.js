OC.L10N.register(
    ...
    "Apply" : "Toepassen",
    "Collabora Online requires a seperate server acting as a WOPI-Client to provide editing capabilities." : "Collabora Online heefteen afzonderlijk server nodig die als WOPI-Client actief is om bewerkfuncties te kunnen leveren.",
    ...
    "All users can edit documents with Collabora Online by default. When this setting is active, only the members of the specified groups can edit and the others can only view documents." : "Alle gebruikers kunnen met Collabora Online bestanden bewerken. Als deze instelling actief is, kunnen alleen leden van de opgegeven groep bewerken en alle anderen alleen lezen.",
