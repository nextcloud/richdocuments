OC.L10N.register(
    ...
    "For ideal document compatibility we recommend you to install commonly used fonts. If your users are working with Microsoft Office installing their proprietary can be done following the documentation." : "للحصول على توافق مثالي للمستندات، نوصيك بتثبيت الخطوط شائعة الاستخدام. إذا كان المستخدمون لديك يعملون على Microsoft Office، فيمكن إجراء تثبيت لخطوطهم باتباع التعليمات الواردة في وثائق المساعدة الخاصة بهم.",
    ...
    "Please check the Collabora Online server log for more details and make sure that Nextcloud can be reached from there." : "لمزيد التفاصل، يٌرجى مراجعة سجل الحركات في كولّابورا Collabora. كما يرجى التأكد من إمكانية الوصول إلى نكست كلاود من هنالك.",
