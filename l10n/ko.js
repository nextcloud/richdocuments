OC.L10N.register(
    ...
    "Saved" : "저장됨",
    "Saved with error: Office Online should use the same protocol as the server installation." : "저장 오류 발생: Office Online과 서버 설치본이 같은 프로토콜을 사용해야 합니다.",
    "Saving…" : "저장 중…",
    "All" : "모두",
