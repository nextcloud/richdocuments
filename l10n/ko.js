OC.L10N.register(
    ...
    "To use Zotero specify your API key here. You can create your API key in your" : "Zotero를 사용하려면 이곳에 API 키를 입력하십시오. Zotero API 키 생성: ",
    "Zotero account API settings." : "Zotero 계정 API 설정 바로가기",
    "Description" : "설명",
