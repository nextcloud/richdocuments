OC.L10N.register(
    ...
    "Nextcloud Office (Collabora)" : "Офіс для Nextcloud (Collabora)",
    "This document was generated using Artificial Intelligence" : "Документ створено із допомогою штучного інтелекту",
    "Headings" : "Заголовок",
    "Sections" : "Розділи",
    "Images" : "Зображення",
    "Sheets" : "Аркуші",
    "Slides" : "Слайди",
    "Generated using Artificial Intelligence" : "Створено із допомогою штучного інтелекту",
    "Office" : "Офіс",
    "Nextcloud Assistant Slide Deck Generator" : "Генератор слайдів Nextcloud Assistant",
    "Generate Slide Deck" : "Створіть набір слайдів",
    "Generate a slide deck from a presentation script" : "Створити набір слайдів на основі сценарію презентації",
    "Presentation script" : "Сценарій презентації",
    "Write the text for your presentation here" : "Напишіть текст для презентації тут",
    "Generated slide deck" : "Згенерована слайд-панель",
    "The slide deck generated" : "Згенерована слайд-дека",
    "Nextcloud Office (Collabora) text document generator" : "Ґенератор текстових документів у Офіс для Nextcloud (Collabora)",
    "Document format" : "Формат документу",
    "The format of the generated document" : "Формат зґенерованого документу",
    "OpenXML (docx)" : "OpenXML (docx)",
    "OpenDocument (odt)" : "OpenDocument (odt)",
    "Portable Document Format (pdf)" : "Портативний формат документа (pdf)",
    "Generate Office text document" : "Зґенерувати офісний текстовий документ",
    "Generate an Office text document from a prompt" : "Зґенерувати офісний текстовий документ із запиту",
    "Instructions" : "Інструкції",
    "Describe the document you want the assistant to generate" : "Опишіть документ, який потрібно зґенерувати асистенту",
    "Generated Office document" : "Зґенерувати офісний документ",
    "The Office document that was generated from the description" : "Офісний документ, який було зґенеровано на основі опису",
    "Nextcloud Office (Collabora) spreadsheet generator" : "Ґенератор табличних документів у Офіс для Nextcloud (Collabora)",
    "OpenXML (xlsx)" : "OpenXML (xlsx)",
    "OpenDocument (ods)" : "OpenDocument (ods)",
    "Generate Office spreadsheet document" : "Зґенерувати офісний табличний документ",
    "Generate an Office spreadsheet document from a prompt" : "Зґенерувати офісну табличний документ із запиту",
    "Empty" : "Порожньо",
    ...
    "Instance-wide templates that should be available to all users." : "Шаблони на рівні примірника хмари мають бути доступні всім користувачам.",
    ...
    "This URL is determined on the Collabora server either from the configured URL or the server_name parameter in coolwsd.xml." : "Це посилання визначено у налаштуваннях сервера Collabora або з налаштувань URL або в параметрі server_name у файлі налаштувань coolwsd.xml.",
    ...
    "Secure view enables you to secure office documents by blocking downloads, previews and showing a watermark" : "Безпечний перегляд дозволяє захистити офісні документи, блокуючи завантаження, попередній перегляд та відображаючи водяний знак.",
    "Downloading the file through WebDAV will be blocked" : "Завантаження файлу через WebDAV буде заблоковано",
    ...
    "Previews will be blocked" : "Попередній перегляд буде заблоковано",
    "Enable secure view" : "Увімкнути безпечний перегляд",
    ...
    "Enforce secure view on tagged files" : "Застосувати безпечний перегляд файлів з мітками",
    "Select tags to enforce watermarking" : "Виберіть мітки для застосування водяних знаків",
    "Enforce secure view for users of groups" : "Забезпечити безпечний перегляд для користувачів груп",
    "Enforce secure view for all shares" : "Увімкніть безпечний перегляд для всіх спільних файлів",
    "Enforce secure view for read only shares" : "Увімкніть безпечний перегляд для дописів \"тільки для читання\"",
    "Enforce secure view for all public Talk shares" : "Ввімкніть безпечний перегляд для всіх публічних дописів у Talk",
    "Enforce secure view for shares without download permission" : "Забезпечити безпечний перегляд для спільних ресурсів без дозволу на завантаження",
    "Enforce secure view for all link shares" : "Ввімкніть безпечний перегляд для всіх спільних ресурсів посилань",
    "Enforce secure view for download hidden shares" : "Увімкніть безпечний перегляд для завантаження прихованих ресурсів",
    "Enforce secure view for read only link shares" : "Ввімкніть безпечний перегляд для спільних посилань \"тільки для читання\"",
    "Enforce secure view on link shares with specific system tags" : "Застосувати безпечний перегляд спільних посилань за допомогою спеціальних системних міток",
    "Select tags to enforce secure view" : "Вибрати мітки, щоб застосувати безпечний перегляд",
    ...
    "Cancel" : "Скасувати",
    "Save As" : "Зберегти як",
    "A file with that name already exists." : "Файл з таким ім'ям вже існує.",
    "Error checking if file exists." : "Помилка з перевіркою наявності файлу",
    "Save as" : "Зберегти як",
    "Path to save" : "Шлях для збереження",
    "Checking…" : "Перевірка...",
    "Invalid file name" : "Недійсне ім'я файлу",
    "File name already exists" : "Ім'я файлу вже існує",
    ...
    "Nextcloud Office" : "Офіс для Nextcloud",
    ...
    "Collabora Online is not setup yet. Please contact your administrator." : "Collabora Online ще не налаштована. Зверніться до адміністратора.",
    "Opening the file is not supported, since the credentials for the external storage are not available without a session" : "Відкриття файлу не підтримується, оскільки облікові дані для зовнішнього сховища недоступні без сеансу.",
