OC.L10N.register(
    ...
    "Nextcloud Office text document generator" : "Ґенератор текстових документів Офісу для Nextcloud",
    ...
    "Nextcloud Office spreadsheet generator" : "Ґенератор таблиць Офісу для Nextcloud",
    ...
    "Enforce secure view on tagged files" : "Увімкніть безпечний перегляд файлів з тегами",
    ...
    "Enforce secure view on link shares with specific system tags" : "Забезпечте безпечний перегляд спільних посилань за допомогою спеціальних системних тегів",
    "Select tags to enforce secure view" : "Виберіть теги, щоб забезпечити безпечний перегляд",
