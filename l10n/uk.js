OC.L10N.register(
    ...
    "Your Nextcloud setup is not capable of connecting to the demo servers because:" : "Ваші налаштування Nextcloud не можуть підключитися до демонстраційних серверів, оскільки:",
    ...
    "{productName} is enabled for all users by default. When this setting is active, only members of the specified groups can use it." : "{productName} увімкнено для всіх користувачів за умовчанням. Коли цей параметр активний, ним можуть користуватися лише учасники вказаних груп.",
    ...
    "Show watermark on tagged files" : "Показувати водяний знак на файлах із тегами",
    "Select tags to enforce watermarking" : "Виберіть теги для застосування водяних знаків",
    ...
    "Show watermark for all link shares" : "Показувати водяний знак для всіх спільних посилань",
    "Show watermark for download hidden shares" : "Показувати водяний знак для прихованих спільних скачувань",
    "Show watermark for read only link shares" : "Показувати водяний знак для спільних посилань лише для читання",
    "Show watermark on link shares with specific system tags" : "Показувати водяний знак на спільних посиланнях із певними системними тегами",
    ...
    "Delete this font" : "Видалити цей шрифт",
