OC.L10N.register(
    ...
    "This application can connect to a Office Online (or other) server (WOPI-like Client). Nextcloud is the WOPI Host. Please read the documentation to learn more about that." : "Ta aplikacja może łączyć się z serwerem Office Online (lub innym klientem WOPI-like). Nextcloud jest hostem WOPI. Proszę przeczytać dokumentację, aby dowiedzieć się więcej na ten temat.",
    ...
    "Enable if your Office Online server uses a self signed certificate" : "Włącz jeżeli serwer Office Online wykorzystuje certyfikat samopodpisany",
    ...
    "Canonical webroot, in case there are multiple, for Office to use. Provide the one with least restrictions. Eg: Use non-shibbolized webroot if this instance is accessed by both shibbolized and non-shibbolized webroots. You can ignore this setting if only one webroot is used to access this instance." : "Webroot Canonical, w przypadku gdy jest ich kilka do użycia przez Office. Wprowadź ten z najmniejszą liczbą ograniczeń. Przykład: Użyj webroot bezszyboletowy jeżeli dostęp do tej instancji mają zarówno webroot szyboletowy, jak i webroot bezszyboletowy . Możesz zignorować to ustawienie, jeżeli tylko jeden webroot jest używany do dostępu do tej instancji.",
