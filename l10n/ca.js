OC.L10N.register(
    ...
    "{productName} is enabled for all users by default. When this setting is active, only members of the specified groups can use it." : "{productName} està activat per defecte per a tots els usuaris. Quan aquesta opció està activa, només els membres dels grups especificats poden utilitzar-la.",
    "Select groups" : "Selecciona els grups",
    "Restrict edit to specific groups" : "Restringeix l’edició a grups específics",
    "All users can edit documents with {productName} by default. When this setting is active, only the members of the specified groups can edit, whereas the others can only view documents." : "Per defecte, tots els usuaris poden editar documents amb {productName}. Quan aquesta opció està activa, només els membres dels grups especificats poden editar, i els altres només poden veure documents.",
    ...
    "Show watermark for shares without download permission" : "Mostra la marca d'aigua per elements compartits sense permisos de descàrrega",
