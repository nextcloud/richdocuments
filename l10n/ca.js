OC.L10N.register(
    ...
    "Saved" : "S'ha desat",
    "Saved with error: Office Online should use the same protocol as the server installation." : "S'ha desat amb error: Office Online hauria de fer servir el mateix protocol que la instal·lació del servidor.",
    ...
    "This application can connect to a Office Online (or other) server (WOPI-like Client). Nextcloud is the WOPI Host. Please read the documentation to learn more about that." : "Aquesta aplicació es pot connectar a un servidor Office Online (o un altre) (client semblant a WOPI). Nextcloud és l'amfitrió de WOPI. Llegiu la documentació per obtenir-ne més informació.",
    ...
    "Office Online is a powerful LibreOffice-based online office suite with collaborative editing, which supports all major documents, spreadsheet and presentation file formats and works together with all modern browsers." : "Office Online és un potent conjunt de productes d'ofimàtica basat en LibreOffice amb edició col·laborativa, que admet tots els documents principals, fulls de càlcul i formats de fitxers de presentació i funciona juntament amb tots els navegadors moderns.",
    "URL (and Port) of Office Online-server" : "URL (i el port) del servidor de Office Online",
    "Apply" : "Aplica",
    "Office Online requires a seperate server acting as a WOPI-like Client to provide editing capabilities." : "Office Online requereix un servidor separat que actuï com a client de WOPI per proporcionar funcions d’edició.",
    "Disable certificate verification (insecure)" : "Desactiva la verificació del certificat (insegur)",
    "Enable if your Office Online server uses a self signed certificate" : "Activeu-ho si el vostre servidor de Office Online fa servir un certificat auto-signat",
    "Restrict usage to specific groups" : "Restringeix l’ús a grups específics",
    "Office Online is enabled for all users by default. When this setting is active, only members of the specified groups can use it." : "Office Online està activat per defecte per a tots els usuaris. Quan aquesta opció està activa, només els membres dels grups especificats poden utilitzar-la.",
    "Restrict edit to specific groups" : "Restringeix l’edició a grups específics",
    "All users can edit documents with Office Online by default. When this setting is active, only the members of the specified groups can edit and the others can only view documents." : "Per defecte, tots els usuaris poden editar documents amb Office Online. Quan aquesta opció està activa, només els membres dels grups especificats poden editar i els altres només poden veure documents.",
    ...
    "Canonical webroot, in case there are multiple, for Office to use. Provide the one with least restrictions. Eg: Use non-shibbolized webroot if this instance is accessed by both shibbolized and non-shibbolized webroots. You can ignore this setting if only one webroot is used to access this instance." : "Webroot Canònic, en cas que hi hagi múltiples opcions per utilitzar Office. Proporcioneu el que tingui menys restriccions. Per exemple: feu servir un webroot no shibbolitzat si s'accedeix a aquesta instància ja sigui per webroots shibbolitzats o no shibbolitzats. Podeu ignorar aquest paràmetre si només es fa servir un webroot per accedir a aquesta instància.",
    ...
    "Templates inside of this directory will be added to the template selector of Office Online." : "Les plantilles d’aquest directori s’afegiran al selector de plantilles de Office Online.",
