OC.L10N.register(
    ...
    "Saved" : "ذخیره شد",
    "Saved with error: Office Online should use the same protocol as the server installation." : "ذخیره شده با خطا: Office آنلاین باید از همان پروتکل نصب سرور استفاده کند.",
    ...
    "Office Online is a powerful LibreOffice-based online office suite with collaborative editing, which supports all major documents, spreadsheet and presentation file formats and works together with all modern browsers." : "Office Online یک مجموعه اداری آنلاین قدرتمند مبتنی بر LibreOffice است که دارای ویرایش کردن مشترک است و از کلیه مستند اصلی ، صفحات گسترده و قالب های ارائه فایل پشتیبانی می کند و در کنار همه مرورگر مدرن کار می کند.",
    "Could not establish connection to the Office Online server." : "اتصال به سرور Office آنلاین برقرار نشد.",
    "Office Online server is reachable." : "سرور آنلاین Office قابل دسترسی است.",
    "Please configure a Office Online server to start editing documents" : "لطفاً برای شروع ویرایش کردن مستند ، سرور Office Online را پیکربندی کنید",
    "Use your own server" : "از سرور خود استفاده کنید",
    "Office Online requires a seperate server acting as a WOPI-like Client to provide editing capabilities." : "Office Online برای ارائه قابلیت های ویرایش به یک سرور مجزا که به عنوان مشتری WOPI مانند فعالیت می کند ، نیاز دارد.",
    "URL (and Port) of Office Online-server" : "URL (و پورت) سرور آنلاین Collabora",
    ...
    "You can use a demo server provided by Office and other service providers for giving Office Online a try." : "برای امتحان کردن Office Online می توانید از یک سرور نسخه ی نمایشی ارائه شده توسط Office و سایر ارائه دهندگان خدمات استفاده کنید.",
    ...
    "Documents opened with the demo server configured will be sent to a 3rd party server. Only use this for evaluating Office Online." : "اسناد با پیکربندی سرور نسخه ی نمایشی باز شده به سرور شخص 3 ارسال می شود. فقط برای ارزیابی Office Online از این استفاده کنید.",
    ...
    "Office Online is enabled for all users by default. When this setting is active, only members of the specified groups can use it." : "Office Online بصورت پیش فرض برای همه کاربران فعال شده است. هنگامی که این تنظیم فعال است ، فقط اعضای گروه های مشخص شده می توانند از آن استفاده کنند.",
    ...
    "Canonical webroot, in case there are multiple, for Office to use. Provide the one with least restrictions. Eg: Use non-shibbolized webroot if this instance is accessed by both shibbolized and non-shibbolized webroots. You can ignore this setting if only one webroot is used to access this instance." : "پارچه معمولی ، در صورت وجود چندین مورد ، برای استفاده از Office است. کمترین محدودیت را برای یکی فراهم کنید. به عنوان مثال: اگر این نمونه از دستبندهای shibbolized و غیر shibbolized قابل دسترسی است ، از پارچه بدون shibbolized استفاده کنید. اگر فقط یک دستبند برای دسترسی به این نمونه استفاده می شود ، می توانید این تنظیمات را نادیده بگیرید.",
    ...
    "Templates inside of this directory will be added to the template selector of Office Online." : "قالب های داخل این فهرست به مسیر الگوی Office Online افزودن.",
