OC.L10N.register(
    ...
    "This application can connect to a Collabora Online (or other) server (WOPI-like Client). Nextcloud is the WOPI Host. Please read the documentation to learn more about that." : "این برنامه می تواند به یک سرور Collabora آنلاین (یا دیگر) (مشتری مانند WOPI) متصل شدن. نکست کلود میزبان WOPI است. لطفاً برای کسب اطلاعات بیشتر درباره آن ، مشتنری را بخوانید.",
