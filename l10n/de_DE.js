OC.L10N.register(
    ...
    "This application can connect to a Office Online (or other) server (WOPI-like Client). Nextcloud is the WOPI Host. Please read the documentation to learn more about that." : "Diese Anwendung kann sich mit einem Office Online Server (WOPI-ähnlicher- Client) verbinden. Nextcloud ist der WOPI-Host. Lesen Sie die Dokumentation, um mehr hierüber zu erfahren.",
    ...
    "Enable if your Office Online server uses a self signed certificate" : "Aktivieren Sie diese Option, wenn Ihr Office Online-Server ein selbstsigniertes Zertifikat verwendet",
