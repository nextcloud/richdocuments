OC.L10N.register(
    ...
    "Files may still be downloadable via WOPI requests if WOPI settings are not correctly configured" : "Dateien können u.U. weiterhin über WOPI-Anforderungen heruntergeladen werden, auch wenn die WOPI-Einstellungen nicht korrekt konfiguriert sind",
    "Previews will be blocked for watermarked files to not leak the first page of documents" : "Vorschauen werden für Dateien mit Wasserzeichen blockiert, damit die erste Seite der Dokumente nicht angezeigt wird",
    ...
    "Open in local editor" : "Lokalen Editor öffnen",
    ...
    "To use Zotero specify your API key here. You can create your API key in your " : "Um Zotero zu verwenden, geben Sie hier Ihren API-Schlüssel an. Ihren API-Schlüssel können Sie erstellen in Ihrer",
    "Zotero account API settings." : "Zotero Konto API-Einstellungen.",
    "This instance does not support Zotero, because the feature is missing or disabled. Please contact the admin." : "Diese Instanz unterstützt Zotero nicht, da die Funktion fehlt oder deaktiviert ist. Bitte wenden Sie sich an die Administration.",
