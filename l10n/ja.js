OC.L10N.register(
    ...
    "Share" : "共有",
    "Share with people on other servers using their Federated Cloud ID username@example.com/owncloud" : "クラウド連携ID（username@example.com/owncloud）を使用して他のサーバー上のユーザーと共有する",
    "Share link" : "URLで共有",
