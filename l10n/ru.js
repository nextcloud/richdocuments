OC.L10N.register(
    ...
    "Accepted file types: {accepts}" : "Допустимые типы файлов: {accepts}",
    ...
    "Zotero" : "Zotero",
    "Enter Zotero API Key" : "Введите API-ключ Zotero",
    "Remove Zotero API Key" : "Удалить API-ключ Zotero",
    ...
    "Could not load templates" : "Не удалось загрузить шаблоны",
