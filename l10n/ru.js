OC.L10N.register(
    ...
    "Guest" : "Гость",
    "Follow current editor" : "Поддерживать текущий редактор",
    ...
    "Apply" : "Применить",
    "Collabora Online requires a seperate server acting as a WOPI-Client to provide editing capabilities." : "Для работы Collabora Online требуется отдельный сервер, выступающий в роли WOPI-клиента для обеспечения возможностей редактирования.",
