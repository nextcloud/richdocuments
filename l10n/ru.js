OC.L10N.register(
    ...
    "If the file does not open in your local editor, make sure the Nextcloud desktop app is installed and open and try again." : "Если файл не открывается в вашем локальном редакторе, убедитесь, что настольное приложение Nextcloud установлено, откройте его и повторите попытку.",
    "Opening file locally …" : "Локальное открытие файла…",
