OC.L10N.register(
    "richdocuments",
    {
    "No files found for this task." : "Отсутствуют файлы для этой задачи.",
    ...
    "Failed to upload the file" : "Не удалось загрузить файл",
    ...
    "Unable to determine the proper file extension for %1$s" : "Не удалось определить подходящее расширение файла для %1$s",
    "Conversion is unavailable for this file." : "Преобразование для этого файла недоступно.",
    "Conversion is blocked because the file is protected by Secure View." : "Преобразование заблокировано, поскольку файл защищен безопасным просмотром.",
    "Unable to fetch information on %1$s" : "Не удается получить информацию о %1$s",
    "PDF (.pdf)" : "PDF (.pdf)",
    "Image (.png)" : "Изображение (.png)",
    "Image (.svg)" : "Изображение (.svg)",
    "Text (.rtf)" : "Текст (.rtf)",
    "Text (.txt)" : "Текст (.txt)",
    "Word Document (.docx)" : "Документ Word (.docx)",
    "OpenDocument Text (.odt)" : "Текст OpenDocument (.odt)",
    "Excel Workbook (.xlsx)" : "Книга Excel (.xlsx)",
    "OpenDocument Spreadsheet (.ods)" : "Таблица OpenDocument (.ods)",
    "PowerPoint Presentation (.pptx)" : "Презентация PowerPoint (.pptx)",
    "OpenDocument Presentation (.odp)" : "Презентация OpenDocument (.odp)",
    ...
    "Diagram" : "Диаграмма",
    "{user} has mentioned you in {node}" : "{user} упомянул вас в {node}",
    "Link to office document section" : "Ссылка на раздел в документе",
    "Nextcloud Office (Collabora)" : "Nextcloud Office (Collabora)",
    "This document was generated using Artificial Intelligence" : "Этот документ был создан с использованием искусственного интеллекта.",
    "Headings" : "Заголовки",
    "Sections" : "Разделы",
    "Images" : "Изображения",
    "Sheets" : "Листы",
    "Slides" : "Слайды",
    "Generated using Artificial Intelligence" : "Создано с использованием искусственного интеллекта",
    "Office" : "Офис",
    "Nextcloud Assistant Slide Deck Generator" : "Генератор слайд-деки помощника Nextcloud Assistant",
    "Generate Slide Deck" : "Создайте колоду слайдов",
    "Generate a slide deck from a presentation script" : "Создайте набор слайдов на основе сценария презентации",
    "Presentation script" : "Сценарий презентации",
    "Write the text for your presentation here" : "Напишите текст для своей презентации здесь",
    "Generated slide deck" : "Сгенерированная колода слайдов",
    "The slide deck generated" : "Сгенерированная колода слайдов",
    "Nextcloud Office (Collabora) text document generator" : "Nextcloud Office (Collabora) генератор текстовых документов",
    "Document format" : "Формат документа",
    "The format of the generated document" : "Формат сгенерированного документа",
    "OpenXML (docx)" : "OpenXML (docx)",
    "OpenDocument (odt)" : "OpenDocument (odt)",
    "Portable Document Format (pdf)" : "Portable Document Format (pdf)",
    "Generate Office text document" : "Создание офисного текстового документа",
    "Generate an Office text document from a prompt" : "Создайте текстовый документ Office на основе запроса",
    "Instructions" : "Инструкции",
    "Describe the document you want the assistant to generate" : "Опишите документ, который вы хотите, чтобы ассистент сгенерировал",
    "Generated Office document" : "Сгенерированный офисный документ",
    "The Office document that was generated from the description" : "Офисный документ, созданный на основе описания",
    "Nextcloud Office (Collabora) spreadsheet generator" : "Nextcloud Office (Collabora) генератор таблиц",
    "OpenXML (xlsx)" : "OpenXML (xlsx)",
    "OpenDocument (ods)" : "OpenDocument (ods)",
    "Generate Office spreadsheet document" : "Создание офисного табличного документа",
    "Generate an Office spreadsheet document from a prompt" : "Создайте документ электронной таблицы Office из командной строки",
    "Empty" : "Пустой",
    ...
    "Instance-wide templates that should be available to all users." : "Шаблоны всего экземпляра, которые должны быть доступны всем пользователям.",
    "Uploaded template \"{name}\"" : "Загруженный шаблон  \"{name}\"",
    "Template \"{name}\" already exists" : "Шаблон \"{name}\" уже существует",
    "Unable to delete template" : "Не удается удалить шаблон",
    "Deleted template" : "Удаленный шаблон",
    "Global Templates" : "Глобальные шаблоны",
    "New" : "Новый",
    "Contact {0} to get an own installation." : "Свяжитесь с {0} чтобы развернуть на своём сервере.",
    "Make sure to set this URL: {url} in the coolwsd.xml file of your Collabora Online server to ensure the added fonts get loaded automatically. Please note that http:// will only work for debug builds of Collabora Online. In production you must use https:// for remote font config." : "Обязательно укажите этот URL-адрес: {url} в этом coolwsd.xml файл вашего сервера Collabora Online, чтобы гарантировать автоматическую загрузку добавленных шрифтов. Пожалуйста, обратите внимание, что http:// будет работать только для отладочных сборок Collabora Online. В рабочей среде вы должны использовать https:// для удаленной настройки шрифтов.",
    ...
    "Nextcloud Office (powered by Collabora Online) is a powerful online office suite with collaborative editing, which supports all major documents, spreadsheet and presentation file formats and works together with all modern browsers." : "Nextcloud Office (на базе Collabora Online) — это мощный онлайн офисный пакет с возможностью совместного редактирования, который поддерживает все основные форматы файлов документов, электронных таблиц и презентаций и работает со всеми современными браузерами.",
    ...
    "This might be due to a missing configuration of your web server. For more information, please visit: " : "Это может быть связано с отсутствием конфигурации вашего веб-сервера. Для получения дополнительной информации посетите:",
    ...
    "Your browser has been unable to connect to the Collabora server:" : "Вашему браузеру не удалось подключиться к серверу Collabora:",
    "This URL is determined on the Collabora server either from the configured URL or the server_name parameter in coolwsd.xml." : "Этот URL-адрес определяется на сервере Collabora либо из настроенного URL-адреса, либо из параметра server_name в поле coolwsd.xml.",
    "Collabora Online server is reachable." : "Сервер Collabora Online доступен.",
    "URL used by the browser:" : "URL-адрес, используемый браузером:",
    "Nextcloud URL used by Collabora:" : "URL-адрес Nextcloud, используемый Collabora:",
    ...
    "Nextcloud Office (Collabora) requires a separate server running Collabora Online to provide editing capabilities." : "Для Nextcloud Office (Collabora) требуется отдельный сервер, на котором работает Collabora Online, чтобы обеспечить возможности редактирования.",
    ...
    "Upload font file" : "Загрузить файл шрифта",
    "Upload a font file" : "Загрузка файла шрифта",
    "Available fonts" : "Доступные шрифты",
    "For ideal document compatibility we recommend you to install commonly used fonts. If your users are working with Microsoft Office, installing their proprietary fonts can be done following the documentation." : "Для идеальной совместимости документов мы рекомендуем вам установить часто используемые шрифты. Если ваши пользователи работают с Microsoft Office, установка их фирменных шрифтов может быть выполнена в соответствии с документацией.",
    "Custom fonts documentation" : "Документация по пользовательским шрифтам",
    "Secure View" : "Безопасный просмотр",
    "Secure view enables you to secure office documents by blocking downloads, previews and showing a watermark" : "Безопасный просмотр позволяет защитить документы Office, блокируя загрузку, предварительный просмотр и отображение водяных знаков",
    "The settings only apply to compatible office files that are opened in Nextcloud Office (Collabora)" : "Эти настройки применяются только к совместимым офисным файлам, которые открываются в Nextcloud Office (Collabora)",
    "Downloading the file through WebDAV will be blocked" : "Загрузка файла через WebDAV будет заблокирована",
    "The following options within Nextcloud Office (Collabora) will be disabled: Copy, Download, Export, Print" : "Следующие параметры в Nextcloud Office (Collabora) будут отключены: копирование, загрузка, экспорт, печать.",
    "Files may still be downloadable via WOPI requests if WOPI settings are not correctly configured" : "Файлы по-прежнему могут загружаться через запросы WOPI, если параметры WOPI настроены неправильно.",
    "Previews will be blocked" : "Предварительный просмотр будет заблокирован",
    "Enable secure view" : "Включить безопасный просмотр",
    ...
    "Enforce secure view on tagged files" : "Обеспечение безопасного просмотра файлов с тегами",
    "Select tags to enforce watermarking" : "Выберите метки, при наличии которых будет показан водяной знак",
    "Enforce secure view for users of groups" : "Обеспечение безопасного просмотра для пользователей групп",
    "Enforce secure view for all shares" : "Обеспечьте безопасный просмотр для всех общих ресурсов",
    "Enforce secure view for read only shares" : "Обеспечьте безопасный просмотр для общих ресурсов, доступных только для чтения",
    "Enforce secure view for all public Talk shares" : "Обеспечьте безопасный просмотр для всех публичных выступлений",
    "Enforce secure view for shares without download permission" : "Обеспечьте безопасный просмотр общих ресурсов без разрешения на загрузку",
    "Enforce secure view for all link shares" : "Обеспечьте безопасный просмотр для всех общих ссылок",
    "Enforce secure view for download hidden shares" : "Обеспечьте безопасный просмотр для загрузки скрытых общих ресурсов",
    "Enforce secure view for read only link shares" : "Обеспечьте безопасный просмотр для общих ссылок, доступных только для чтения",
    "Enforce secure view on link shares with specific system tags" : "Обеспечьте безопасный просмотр общих ссылок с помощью определенных системных тегов",
    "Select tags to enforce secure view" : "Выберите теги для обеспечения безопасного просмотра",
    "Electronic Signature" : "Электронная подпись",
    "Client ID for the electronic signature API" : "Идентификатор клиента для API электронной подписи",
    "Fill in the registration form at https://eideasy.com/signup to obtain a client ID and secret." : "Заполните регистрационную форму по адресу https://eideasy.com/signup, чтобы получить идентификатор клиента и секретную информацию.",
    "Secret for the electronic signature API" : "Секрет для API электронной подписи",
    "The secret may be downloadable via WOPI requests if WOPI allow list is not correctly configured." : "Секрет может быть загружен с помощью запросов WOPI, если список разрешений WOPI настроен неправильно.",
    "Save" : "Сохранить",
    "Remove" : "Исключить",
    "Please enter the guest name you wish to use before proceeding to the document. If you don't provide one, the default will be used." : "Пожалуйста, введите имя гостя, которое вы хотите использовать, прежде чем переходить к оформлению документа. Если вы его не укажете, будет использовано имя по умолчанию.",
    ...
    "Error checking if file exists." : "Ошибка проверки существования файла.",
    "Save as" : "Сохранить как",
    ...
    "Personal Settings for Nextcloud Office (Collabora)" : "Персональные настройки для Nextcloud Office (Collabora)",
    "Select a template directory" : "Папка шаблонов документов",
    "Remove personal template folder" : "Удалить папку с личными шаблонами",
    "Templates inside of this directory will be added to the template selector of Nextcloud Office (Collabora)." : "Шаблоны внутри этого каталога будут добавлены в селектор шаблонов Nextcloud Office (Collabora).",
    "Document signing" : "Подписание документов",
    "Enter document signing cert (in PEM format)" : "Введите сертификат подписи документа (в формате PEM)",
    "Enter document signing key" : "Введите ключ для подписи документа",
    "Enter document signing CA chain" : "Войдите в цепочку центров сертификации для подписания документов",
    "To use document signing, specify your signing certificate, key and CA chain here." : "Чтобы использовать функцию подписи документов, укажите здесь свой сертификат подписи, ключ и цепочку центров сертификации.",
    "This instance does not support document signing, because the feature is missing or disabled. Please contact the administrator." : "Этот экземпляр не поддерживает подписание документов, поскольку данная функция отсутствует или отключена. Пожалуйста, свяжитесь с администратором.",
    ...
    "Edit" : "Редактирование",
    "Starting the built-in CODE server …" : "Запуск встроенного сервера CODE…",
    ...
    "Cluster is scaling …" : "Кластер масштабируется …",
    "The collaborative editing was terminated by another user" : "Совместное редактирование было прекращено другим пользователем",
    ...
    "Socket connection closed unexpectedly. The reverse proxy might be misconfigured, please contact the administrator." : "Соединение с сокетом неожиданно прервалось. Возможно, обратный прокси-сервер настроен неправильно, обратитесь к администратору.",
    "More information can be found in the reverse proxy documentation" : "Более подробную информацию можно найти в документации по обратному прокси-серверу",
    "Close" : "Закрыть",
    ...
    "Insert into document" : "Вставить в документ",
    "Open file locally" : "Открыть файл локально",
    "When opening a file locally, the document will close for all users currently viewing the document." : "При локальном открытии файла документ будет закрыт для всех пользователей, просматривающих документ в данный момент.",
    "Open locally" : "Открыть локально",
    "Continue editing online" : "Продолжить редактирование онлайн",
    ...
    "Retry to open locally" : "Повторите попытку открытия локально",
    "Save a copy of the file under a new name and continue editing the new file" : "Сохраните копию файла под новым именем и продолжите редактирование нового файла",
    "Failed to revert the document to older version" : "Не удалось вернуться к ранней версии",
    "Starting the built-in CODE server is taking longer than expected" : "Запуск встроенного сервера CODE занимает больше времени, чем ожидалось",
    "Insert file from {name}" : "Вставить файл из {name}",
    ...
    "New file" : "Новый файл",
    "Please enter the filename for the new file" : "Пожалуйста, введите имя нового файла",
    ...
    "Collabora Online is not setup yet. Please contact your administrator." : "Программа Collabora Online еще не настроена. Пожалуйста, свяжитесь со своим администратором.",
    "Opening the file is not supported, since the credentials for the external storage are not available without a session" : "Открытие файла не поддерживается, так как учетные данные для внешнего хранилища недоступны без сеанса",
    ...
    "Last saved version" : "Последняя сохранённая версия",
    "Current version (unsaved changes)" : "Текущая версия (несохранённые изменения)",
    ...
    "Open with {productName}" : "Открыть с помощью {productName}",
    "Global templates" : "Глобальные шаблоны",
    ...
    "The settings only apply to compatible office files that are opened in Nextcloud Office" : "Настройки применяются только к совместимым офисным файлам, которые открываются в Nextcloud Office.",
    "The following options within Nextcloud Office will be disabled: Copy, Download, Export, Print" : "Следующие параметры в Nextcloud Office будут отключены: копирование, загрузка, экспорт, печать.",
    "Files may still be downloadable through Nextcloud unless restricted otherwise through sharing or access control settings" : "Файлы по-прежнему могут быть загружены через Nextcloud, если иное не ограничено настройками общего доступа или контроля доступа.",
    "Previews will be blocked for watermarked files to not leak the first page of documents" : "Предварительный просмотр будет заблокирован для файлов с водяными знаками, чтобы не произошла утечка первой страницы документов.",
    "Show watermark for shares without download permission" : "Показывать водяной знак для опубликованных файлов без разрешения на загрузку",
    "New drawing" : "Новая схема",
