OC.L10N.register(
    ...
    "Conversion is unavailable for this file." : "Níl tiontú ar fáil don chomhad seo.",
    "Conversion is blocked because the file is protected by Secure View." : "Tá bac ar an gcomhshó mar go bhfuil an comhad faoi chosaint ag Secure View.",
    ...
    "Nextcloud Office (Collabora)" : "Oifig Nextcloud (Collabora)",
    "This document was generated using Artificial Intelligence" : "Gineadh an doiciméad seo ag baint úsáide as Intleacht Shaorga",
    "Headings" : "Ceannteidil",
    "Sections" : "Ailt",
    "Images" : "Íomhánna",
    "Sheets" : "Bileoga",
    "Slides" : "Sleamhnáin",
    "Generated using Artificial Intelligence" : "Gineadh ag baint úsáide as Intleacht Shaorga",
    "Office" : "Oifig",
    "Nextcloud Assistant Slide Deck Generator" : "Gineadóir Deic Sleamhnán Cúnta Nextcloud",
    "Generate Slide Deck" : "Gin Deic Sleamhnán",
    "Generate a slide deck from a presentation script" : "Gin deic sleamhnán ó script cur i láthair",
    "Presentation script" : "Script cur i láthair",
    "Write the text for your presentation here" : "Scríobh an téacs do do chur i láthair anseo",
    "Generated slide deck" : "Deic sleamhnán ginte",
    "The slide deck generated" : "An deic sleamhnán a gineadh",
    "Nextcloud Office (Collabora) text document generator" : "Gineadóir doiciméad téacs Nextcloud Office (Collabora)",
    "Document format" : "Formáid doiciméad",
    "The format of the generated document" : "Formáid an doiciméid a ghintear",
    "OpenXML (docx)" : "OpenXML (docx)",
    "OpenDocument (odt)" : "OpenDocument (odt)",
    "Portable Document Format (pdf)" : "Formáid Doiciméad Iniompartha (pdf)",
    "Generate Office text document" : "Gin doiciméad téacs Office",
    "Generate an Office text document from a prompt" : "Gin doiciméad téacs Office ó leid",
    "Instructions" : "Comhaid Nextcloud ag teastáil",
    "Describe the document you want the assistant to generate" : "Déan cur síos ar an doiciméad a theastaíonn uait don chúntóir a ghiniúint",
    "Generated Office document" : "Doiciméad oifige ginte",
    "The Office document that was generated from the description" : "Doiciméad na hOifige a gineadh ón tuairisc",
    "Nextcloud Office (Collabora) spreadsheet generator" : "Gineadóir scarbhileog Nextcloud Office (Collabora)",
    "OpenXML (xlsx)" : "OpenXML (xlsx)",
    "OpenDocument (ods)" : "OpenDocument (ods)",
    "Generate Office spreadsheet document" : "Gin doiciméad scarbhileog na hOifige",
    "Generate an Office spreadsheet document from a prompt" : "Gin doiciméad scarbhileog Oifige ó leid",
    "Empty" : "Folamh",
    ...
    "Instance-wide templates that should be available to all users." : "Teimpléid uile-chineálacha ba chóir a bheith ar fáil do gach úsáideoir.",
    ...
    "Nextcloud Office (powered by Collabora Online) is a powerful online office suite with collaborative editing, which supports all major documents, spreadsheet and presentation file formats and works together with all modern browsers." : "Is sraith oifige ar líne chumhachtach í Nextcloud Office (faoi thiomáint ag Collabora Online) le heagarthóireacht chomhoibríoch, a thacaíonn le gach mórfhormáid comhaid doiciméad, scarbhileog agus cur i láthair agus a oibríonn i gcomhar le gach brabhsálaí nua-aimseartha.",
    ...
    "Nextcloud Office (Collabora) requires a separate server running Collabora Online to provide editing capabilities." : "Éilíonn Nextcloud Office (Collabora) freastalaí ar leithligh a bhfuil Collabora Online á rith aige chun cumais eagarthóireachta a sholáthar.",
    ...
    "Secure view enables you to secure office documents by blocking downloads, previews and showing a watermark" : "Leis an radharc slán, is féidir leat doiciméid oifige a dhaingniú trí íoslódálacha, réamhamhairc agus comhartha uisce a thaispeáint a bhac.",
    "The settings only apply to compatible office files that are opened in Nextcloud Office (Collabora)" : "Ní bhaineann na socruithe ach le comhaid oifige comhoiriúnacha atá oscailte in Nextcloud Office (Collabora)",
    "Downloading the file through WebDAV will be blocked" : "Cuirfear bac ar an gcomhad a íoslódáil trí WebDAV",
    "The following options within Nextcloud Office (Collabora) will be disabled: Copy, Download, Export, Print" : "Beidh na roghanna seo a leanas laistigh de Nextcloud Office (Collabora) díchumasaithe: Cóipeáil, Íoslódáil, Easpórtáil, Priontáil",
    ...
    "Previews will be blocked" : "Cuirfear bac ar réamhamhairc",
    "Enable secure view" : "Cumasaigh radharc slán",
    ...
    "Enforce secure view on tagged files" : "Forfheidhmigh radharc slán ar chomhaid chlibeáilte",
    "Select tags to enforce watermarking" : "Roghnaigh clibeanna chun comhartha uisce a chur i bhfeidhm",
    "Enforce secure view for users of groups" : "Forfheidhmigh radharc slán d'úsáideoirí grúpaí",
    "Enforce secure view for all shares" : "Forfheidhmigh radharc slán do gach scaireanna",
    "Enforce secure view for read only shares" : "Forfheidhmigh radharc slán le haghaidh scaireanna inléite amháin",
    "Enforce secure view for all public Talk shares" : "Forfheidhmigh radharc slán do gach scaireanna poiblí Talk",
    "Enforce secure view for shares without download permission" : "Forfheidhmigh radharc slán le haghaidh scaireanna gan chead íoslódála",
    "Enforce secure view for all link shares" : "Forfheidhmigh radharc slán do gach comhroinnt nasc",
    "Enforce secure view for download hidden shares" : "Forfheidhmigh radharc slán le haghaidh scaireanna i bhfolach a íoslódáil",
    "Enforce secure view for read only link shares" : "Forfheidhmigh radharc slán le haghaidh comhroinnt nasc léite amháin",
    "Enforce secure view on link shares with specific system tags" : "Forfheidhmigh radharc slán ar chomhroinnt nasc le clibeanna córais shonracha",
    "Select tags to enforce secure view" : "Roghnaigh clibeanna chun radharc slán a fhorfheidhmiú",
    ...
    "Cancel" : "Cealaigh",
    "Save As" : "Sábháil mar",
    "A file with that name already exists." : "Tá comhad leis an ainm sin ann cheana féin.",
    "Error checking if file exists." : "Earráid ag seiceáil an bhfuil comhad ann.",
    "Save as" : "Sábháil mar",
    "Path to save" : "Conair a shábháil",
    "Checking…" : "Ag seiceáil…",
    "Invalid file name" : "Ainm comhaid neamhbhailí",
    "File name already exists" : "Tá ainm comhaid ann cheana féin",
    ...
    "Personal Settings for Nextcloud Office (Collabora)" : "Socruithe Pearsanta le haghaidh Nextcloud Office (Collabora)",
    "Select a template directory" : "Roghnaigh eolaire teimpléid",
    "Remove personal template folder" : "Bain fillteán teimpléid pearsanta",
    "Templates inside of this directory will be added to the template selector of Nextcloud Office (Collabora)." : "Cuirfear teimpléid atá taobh istigh den eolaire seo le roghnóir teimpléid Nextcloud Office (Collabora).",
    ...
    "Preview" : "Réamhamharc",
    "Edit" : "Cuir in eagar",
    "Starting the built-in CODE server …" : "Ag tosú an fhreastalaí CODE ionsuite …",
    ...
    "Starting the built-in CODE server is taking longer than expected" : "Tá sé ag tógáil níos faide ná mar a bhíothas ag súil leis an bhfreastalaí CODE ionsuite a thosú",
    ...
    "Collabora Online is not setup yet. Please contact your administrator." : "Níl Collabara Online socraithe fós. Téigh i dteagmháil le do riarthóir.",
    "Opening the file is not supported, since the credentials for the external storage are not available without a session" : "Ní thacaítear leis an gcomhad a oscailt, ós rud é nach bhfuil na dintiúir don stóráil sheachtrach ar fáil gan seisiún",
